...
> **229 dated entries · 2026-05-22 → 2026-09-19 · refreshed 2026-09-20 10:41 PDT**
>
...
**2026-05**
- `2026-05-22` `L296` Burry Part III corroboration + his own hedges (source 2026-05-22, `raw/2026-05-22-burry-heretics-guide-part-3.md`)
**2026-06**
- `2026-06-30` `L6257` DATA (MEASURED — SEC 10-Q, period ended 2026-06-30)
**2026-07**
- `2026-07-03` `L255` DATA (verified — WebSearch 2026-07-03)
- `2026-07-07` `L324` ⚡ 2026-07-07 — the credit leg goes LIVE: ORCL CDS at record
- `2026-07-08` `L335` Counterweight — capacity is LOOSE; the fuse is POLITICAL (2026-07-08, from Jake's Jul-6/7 log)
- `2026-07-10` `L362` 2026-07-10 — hyperscaler paper is now ~9% of ALL IG supply
- `2026-07-10` `L372` 2026-07-10 — S&P cuts ORCL to BBB- (one notch above junk), stable outlook
- `2026-07-12` `L383` 2026-07-12 — MS: private-credit "liquidity stress not translating into solvency risk" (headline)
- `2026-07-13` `L397` 2026-07-13 ~2:45am — "Did Goldman just pop the AI debt bubble" (ZH paywalled; reconstructed from fragments)
- `2026-07-13` `L430` 2026-07-13 ~3am — CONFIRMED: the Papai quote (GS FICC, via Jake)
- `2026-07-13` `L455` 2026-07-13 ~3:15am — Jake's mechanism catch: WHY the buyers struck + where funding migrates
- `2026-07-13` `L472` 2026-07-13 ~3:30am — Papai story fully resolved (Jake's Perplexity pull)
- `2026-07-13` `L491` 2026-07-13 ~1:30pm PT — the Apollo per-company FCF chart: ORCL IS the negative wing, quantified
- `2026-07-14` `L514` 2026-07-14 ~3:20am PT — drawdown-vs-FCF cross-check (Jake's Q, ModestWallet chart)
- `2026-07-14` `L548` 2026-07-14 ~8:25am PT — MAG7 workbook QUANTIFIES the squeeze (Jake's upload, independent build)
- `2026-07-14` `L549` DATA (observed — reported 10-K FCF/capex; see raw/2026-07-14-mag7-fcf-capex-token-workbook.md)
- `2026-07-14` `L573` 2026-07-14 ~10:25pm PT — the FUNDING GAP quantified: $4-8T capex, no FCF, strained credit (ZH cluster)
- `2026-07-15` `L599` 2026-07-15 ~7:14am PT — the financing-fragility thesis PRINTS: hyperscaler credit stress at a RECORD
- `2026-07-15` `L618` 2026-07-15 ~11:51am PT — Slok: hyperscaler bond COVER RATIO 5x (Feb) → below 2x (July)
- `2026-07-17` `L649` 2026-07-17 ~7:20am PT — THE TRIPWIRE FIRES: hyperscaler BOND market carnage (mechanism confirms the vibe)
- `2026-07-19` `L692` 2026-07-19 ~6pm PT — 30Y at 5.06% (highest auction since 2007): AI-debt crowding-out goes MACRO
- `2026-07-19` `L724` 2026-07-19 ~10:25pm PT — Jake's avalanche synthesis: sharpened (CEPI-margin, levered-edge, yen-carry-corners-Fed)
- `2026-07-19` `L752` 2026-07-19 ~10:35pm PT — ⚠️ CORRECTION to the entry above (Jake's pushback; I over-hedged the Mag-7 insulation)
- `2026-07-19` `L778` 2026-07-19 ~10:40pm PT — the levered-edge crack PRINTS: Meta rents excess compute → neoclouds dump 6-10%
- `2026-07-20` `L804` 2026-07-20 ~10:40am PT — private-credit → IG via insurance WRAPPERS (the AIG rhyme): a new channel into pensions
- `2026-07-21` `L837` 2026-07-21 ~7am PT — the credit leg FIRES on a name: Oracle CDS at multi-year high (Jake's "$2TN won't get paid")
- `2026-07-22` `L865` 2026-07-22 ~7:30am PT — the credit leg goes MAINSTREAM + a fresh circular node (AMD→Anthropic $5B)
- `2026-07-22` `L892` 2026-07-22 ~3:50pm PT — the CREDIT LEG fires across names: hyperscaler bonds "slaughtered," SpaceX bonds at JUNK, G-sp
- `2026-07-22` `L922` 2026-07-22 ~4:45pm PT — AMD-Anthropic DETAIL (WSJ): the LEASE BACKSTOP upgrades the wire from correlated to credit-tra
- `2026-07-23` `L937` 2026-07-23 ~10:20am PT — the OFF-BALANCE-SHEET layer: Google $811B contracted commitments (+$500B in ONE quarter); ~$2
- `2026-07-23` `L962` 2026-07-23 ~11:30am PT — the credit leg goes from STRESS to BREAK: investors "refuse to fund memory chip purchases"; b
- `2026-07-23` `L986` 2026-07-23 ~1pm PT — HARD DATA on the credit break: it's DISCRIMINATING (levered periphery breaks, cash-rich core pris
- `2026-07-23` `L1010` 2026-07-23 ~8:05pm PT — THE FAILURE-MODE PLUMBING (Jake's 4 questions) + the off-switch is a TRIGGER not a floor
- `2026-07-23` `L1058` 2026-07-23 ~8:12PM PT — WHICH cut-signal is worse: SOLVENCY (ROI) vs LIQUIDITY (financing) + the PACE tell (Jake)
- `2026-07-24` `L1083` 2026-07-24 ~6:20am PT — FRAGILITY GOES LOUD on 4 fronts (Fri pre-market scan) — but still WIDEN not SEIZE
- `2026-07-24` `L1107` 2026-07-24 ~6:25AM PT — GOLDMAN full quote: the Beignet SPV crack (Meta) + "revenue inflects before spending peaks" + 
- `2026-07-24` `L1140` 2026-07-24 ~6:35AM PT — ORACLE 5yr CDS record ~203bps (Bloomberg chart) — idiosyncratic WIDEN, junk-cut = the systemic
- `2026-07-24` `L1163` 2026-07-24 ~6:44AM PT — Meta's NEXT datacenter debt raise ($12.3B BlackRock) "could cost MORE than its 2025 record" + 
- `2026-07-24` `L1175` 2026-07-24 ~12:15PM PT — CREDIT LEG charts at RECORD WIDES (3 ZH charts) + Ed Dowd "caution warranted" (consensus-perm
- `2026-07-24` `L1188` 2026-07-24 ~5:23PM PT — BEIGNET SPV G-spread goes VERTICAL to 229bps (ZH chart) — the pace-tell's biggest move, but "b
- `2026-07-24` `L1197` 2026-07-24 ~7:43pm PT — THE PRIVATE-CREDIT TAXPAYER BACKSTOP (Drall & Granato law-review paper) — failure-mode #2 deep
- `2026-07-24` `L1216` 2026-07-24 ~7:56PM PT — THE TATTLE-TELLER SIGNAL (Jake): prudent insurers as motivated informants — and why SILENCE is
- `2026-07-24` `L1223` ⚠️ REFINEMENT (2026-07-24 ~7:59PM PT) — Jake: "they know exactly what's happening, they don't need to extrapolate from
- `2026-07-24` `L1229` 2026-07-24 ~8:48PM PT — JAKE'S SYNTHESIS graded (the AI-capex → PE → insurer → guaranty-fund → taxpayer chain) + the S
- `2026-07-24` `L1237` 2026-07-24 ~8:52PM PT — "What stopped them until now?" (Jake) — the subsidy lay DORMANT 40 years; ZIRP switched it on
- `2026-07-24` `L1247` 2026-07-24 ~8:54PM PT — ⚠️ better question (Jake, I misread first): "what stopped them from just offering higher rates
- `2026-07-24` `L1257` 2026-07-24 ~8:57PM PT — "So it's just risk… but don't they get sued?" (Jake) — NO: state receivership, not bankruptcy;
- `2026-07-24` `L1268` 2026-07-24 ~8:59PM PT — ★ THE "SO WHAT" (Jake: "I'm just confused what the consequence is") — it's a BUFFER, not a BOM
- `2026-07-24` `L1276` 2026-07-24 ~9:03PM PT — ★ "Why WOULDN'T they do it?" (Jake) — DOMINANT STRATEGY + "the risk doesn't feel like risk" (…
- `2026-07-24` `L1282` 2026-07-24 ~9:08PM PT — ★ JAKE'S INVERSION: "NOT blowing up is the higher risk" — MINSKY + fire-suppression (corrects 
- `2026-07-24` `L1290` ⚠️ CORRECTION (2026-07-24 ~9:25pm PT) — "backstop" was the wrong word; it's ONE POOL reallocated, not two pools where 
- `2026-07-24` `L1298` 2026-07-24 ~10:47pm PT — GOOGLE DISCLOSES $94.1B SPACEX STAKE (6%) — the receipt for Wednesday's $99B "gain on equity 
- `2026-07-24` `L1312` 2026-07-24 ~11:06PM PT — SEC-SCANNER first full run (Jake ran it in Colab): the corrected AMZN read = NEGATIVE $72.7B 
- `2026-07-24` `L1324` 2026-07-24 ~11:07PM PT — addendum from Jake's full v1 run: META is the LEAST XBRL-LEGIBLE hyperscaler — and that's the
- `2026-07-24` `L1334` 2026-07-24 ~11:08PM PT — v2 run confirmed clean (Jake, Colab) + one residual: ORCL row now suspect in the OTHER direct
- `2026-07-26` `L1371` 2026-07-26 ~4:03pm PT — THE GOLDEN-WINDOW MATH QUANTIFIED ($725B capex vs $211B depreciation) + GOOGL buyback PAUSE + 
- `2026-07-26` `L1405` 2026-07-26 ~5:38pm PT — THE BIGGEST CIRCLE YET: NVDA to GUARANTEE ~$250B of OpenAI's Ohio lease/debt + finance the $35
- `2026-07-26` `L1442` 2026-07-26 ~5:55pm PT — JAKE'S ECLIPSE SYNTHESIS (graded): the capex shadow reaches the check-cashers; the IPO race wa
- `2026-07-26` `L1477` 2026-07-26 ~6:10pm PT — JAKE PART 2 (graded): everyone was priced as THE winner; the Jevons bet is now priced-beyond-p
- `2026-07-27` `L1511` 2026-07-27 ~5:50am PT — SPACEX CRACKS POST-LISTING: the private-marks thesis printing at the flagship (collector run #
- `2026-07-27` `L1529` 2026-07-27 ~6:25am PT — NVDA→SSI: the purest circular specimen yet + the TPU flip + Jake's "frontloading intent" read
- `2026-07-27` `L1561` 2026-07-27 ~10:45am PT addendum — the SSI number lands: $5 BILLION (ZH relay, as-reported)
- `2026-07-27` `L1578` 2026-07-27 ~2:10pm PT — THE WIDEN-TRIGGER GETS DATA: hyperscaler CDS at RECORD wides, +3bps more, "unprecedented carna
- `2026-07-27` `L1598` 2026-07-27 ~6:45pm PT — THE CREDIT PANEL, WITH NUMBERS (ZH charts via Jake; raw/ x3) — the quality ladder is fully pri
- `2026-07-28` `L1630` 2026-07-28 ~12:15pm PT — ★ THE STEELMAN: the spot-vs-contract repricing bull case (Jake's paste) — the strongest count
- `2026-07-28` `L1698` 2026-07-28 ~1:35pm PT — ★ JAKE'S REFINEMENT: the bear is the MECHANISM (tranching + distribution), not the number — an
- `2026-07-28` `L1750` 2026-07-28 ~1:50pm PT — THE DC-PLAN CHANNEL, VERIFIED (with a correction) + the Bermuda leg: both ends of the distribu
- `2026-07-28` `L1832` 2026-07-28 ~5:10pm PT — ★ THE CHANNEL NARROWS, MEASURED: Asian private-credit fundraising at a decade low — the rate-t
- `2026-07-28` `L1833` DATA (FT / PitchBook chart, `raw/2026-07-28-asia-private-credit-fundraising-ft.png`)
- `2026-07-28` `L1875` 2026-07-28 close ~7:20pm PT — ★★ BANKS HIT SECTOR LIMITS ON DATA-CENTRE LOANS + A ONE-IN-THREE FED HIKE BID
- `2026-07-29` `L1876` DATA (collector CSV 7/29 02:09 UTC, archived `raw/archive/2026-07-29-0209utc-vault-headlines.csv`)
- `2026-07-29` `L1922` 2026-07-29 ~8:45am PT — ★★★ META MOVES CAPEX OFF BALANCE SHEET INTO A BLACKROCK JV — JAKE'S MECHANISM, NAMED AND PRICE
- `2026-07-29` `L1966` 2026-07-29 ~9:06am PT (PRE-FOMC) — ★★★ THE NEOCLOUDS BROKE. ALL SIX, DOUBLE DIGITS, IN ONE SESSION.
- `2026-07-29` `L2015` 2026-07-29 ~2:05pm PT — ★★★ THE RAZOR IS NOT "BEAT-SOLD." IT IS "CAPEX-RAISE-SOLD." SAME NIGHT, TWO NAMES, ONE VARIABL
- `2026-07-29` `L2124` 2026-07-29 ~10:55pm PT — ★★ TWO SPV DEALS IN ONE DAY: the private-credit mechanism this note registered as a MECHANISM
- `2026-07-30` `L2071` 2026-07-30 ~5:35am UTC feed / ~7:00am PT — ★★★ THE RAZOR REFINES AGAIN: IT IS CAPEX **OPTIONALITY**, NOT CAPEX DIRECTI
- `2026-07-30` `L2157` 2026-07-30 ~12:44am PT — ★★ THE PRIMARY-MARKET READ I ASKED FOR ARRIVES, AND IT IS A BROKEN DEAL — plus Meta hints at 
- `2026-07-30` `L2184` 2026-07-30 ~6:30am PT — ★★★ THE OPTIONALITY RAZOR GETS ITS CLEANEST TEST AND CONFIRMS — and it makes F1 MORE urgent, n
- `2026-07-30` `L2210` 2026-07-30 ~10:10am ET — ⚠️ "ARCHEGOS 2.0" (Jake): the supporting document is a 5-day-old TAUNT with no evidence in it
- `2026-07-30` `L2254` 2026-07-30 ~9:20am ET — ★★★ F8 FIRES: THE NAMED CASUALTY IS SITUATIONAL AWARENESS LP — verified, and it is STRESSED, n
- `2026-07-30` `L2308` 2026-07-30 ~9:35am ET — ★★★ BLUE OWL FUNDRAISING SLOWDOWN (BBG, Jake): this is F2 getting information, and it is the S
- `2026-07-30` `L2357` 2026-07-30 ~9:50am ET — ★★★ CITADEL BUYS SITUATIONAL AWARENESS'S STOCK PORTFOLIO (WSJ, via Jake) — a bilateral block s
- `2026-07-30` `L2395` 2026-07-30 ~10:05am ET — ⛔ I SPLIT HAIRS AND JAKE WAS RIGHT: the redemptions had ALREADY happened. But the PRICES inve
- `2026-07-30` `L2451` 2026-07-30 ~10:25am ET — ⛔ THE OBDC II MATERIAL IS FIVE MONTHS OLD: verified to FEBRUARY 19-20, 2026, and the digest p
- `2026-07-30` `L2497` 2026-07-30 ~10:30am ET — ★★★ THE SCALE REVISES: $45bn NAV ON JULY 1, "CRISIS MODE" (WSJ) — and the crisis is NOT the l
- `2026-07-30` `L2547` 2026-07-30 11:00am ET — ⛔ ASSETS TO $10bn FROM $45bn (ZH): I CONFLATED ORDERLY WITH SURVIVABLE, and the concession is 
- `2026-07-30` `L2593` 2026-07-30 ~11:20am ET — ★★ THE SNDK HOLDER SCREEN: SA IS ON IT, and the European delta-one banks are the real tell (B
- `2026-07-30` `L2638` 2026-07-30 ~11:30am ET — ★★★ THE HISTORICAL TAB: EVERY TOP-28 HOLDER ADDED, DEALERS LED, AND SEVEN POSITIONS CAME FROM
- `2026-07-30` `L2688` 2026-07-30 ~11:45am ET — ★★★ THE NEXUS/ANTHROPIC/GOOGLE DEAL IS THE SPV MECHANISM MADE FULLY EXPLICIT — and it is the 
- `2026-07-30` `L2744` 2026-07-30 ~3:22pm PT — ★★★ THE LOOP CLOSES INSIDE A HYPERSCALER'S NET INCOME: AMZN's $53B Anthropic mark
- `2026-07-31` `L2775` 2026-07-31 ~10:30am PDT — ANTHROPIC'S CYBER-EVAL INCIDENTS: the risk is not the breach, it is WHOSE P&L the mark sits 
- `2026-07-31` `L2828` 2026-07-31 ~10:45am PDT — ⛔ THE ENTRY ABOVE WAS WRITTEN WITHOUT THE REGULATORY HISTORY. It is already TWO actions deep
- `2026-07-31` `L2868` 2026-07-31 ~11:00am PDT — ⛔⛔ CORRECTION: THE VAULT ALREADY HAD ALL OF THIS. I searched the WEB and not the VAULT.
- `2026-07-31` `L2902` 2026-07-31 ~2:10pm PDT — ★★★ "DOES A FINANCING BREAK HAVE THE BREADTH TO REACH SPY?" — it reaches SPX iff it reaches D
- `2026-07-31` `L2952` 2026-07-31 ~9:47pm PDT — REUTERS: OPENAI FOUND *MORE* CONTAINMENT ESCAPES — and Trump said "we're looking at controls"
**2026-08**
- `2026-08-01` `L3042` 2026-08-01 ~1:20pm PDT — ⛔ THE YEN INTERVENTION: Jake's 7/19 TELL MOVED — and it may be what sold the long end
- `2026-08-02` `L3104` 2026-08-02 ~3:20pm PDT — ★★★ BIG TECH AS A DURATION-SUPPLY SHOCK: a channel this vault never had
- `2026-08-03` `L3169` 2026-08-03 ~9:15am PDT — THE AI FRAMEWORK ARRIVES **VOLUNTARY AND UNPUBLISHED**
- `2026-08-04` `L3295` 2026-08-04 ~12:10pm PDT — ★★★★ THE FIELD REPORT: SA's filed book was 62% PUTS — the "levered AI long" frame dies on th
- `2026-08-05` `L3420` 2026-08-05 ~8:40am PDT — EISEN'S $3T: the do-not-add error at broadcast scale — and the mainstreaming IS the datum
- `2026-08-05` `L3429` ⟲ AMENDMENT 2026-08-05 ~9:20am PDT — ⛔ THE SA "WRAPPER-CANCELLATION" HYPOTHESIS CORRECTED TO **BETA MISMATCH**
- `2026-08-05` `L3442` 2026-08-05 ~9:55am PDT — ★★★ GOOGLE'S LEADERSHIP RESET + THE DEAN/GHEMAWAT EXIT: the circularity thread extends from C
- `2026-08-05` `L3481` 📌 2026-08-05 ~10:50am PDT — 🚩 FETCH: Market Ear, "Remember hyperscaler CDS spreads?" — chart unseen, not graded
- `2026-08-06` `L3489` 📌 2026-08-06 ~8:30am PDT — OBDC Q2: LOPAREX TO NON-ACCRUAL — the legacy book confesses inside the AI lending machine (
- `2026-08-06` `L3527` 2026-08-06 ~8:40am PDT — ★★★★ THE CREDIT MARKET HAS PRINTED ON THE AI DEBT STACK: CDS record-wides (July), spreads re-
- `2026-08-06` `L3597` 2026-08-06 ~10:40am PDT — ★★★★ THE GS "YOU ARE HERE" CHART: five hyperscalers COMBINED go FCF-NEGATIVE this quarter — 
- `2026-08-06` `L3643` 2026-08-06 ~12:15pm PDT — HANDOFF: the off-BS paper's first mark is STRONG (Meta SPV +3pts/70bp tighter), the PIK pipe
- `2026-08-06` `L3666` 📌 2026-08-06 ~2:35pm PDT — 🚩 HEADLINE-CLASS FLAG: GS reportedly finds "HALF the S&P's 'record' earnings growth is Big 
- `2026-08-07` `L3675` 2026-08-07 ~2:55pm PDT — ★★★★ **THE AI CREDIT BASIS IS BORN AND QUANTIFIED (25bp vs 6bp) — and the "20x synthetic" lin
- `2026-08-08` `L3734` 2026-08-08 ~11:40pm PDT — ★★★ THE CDS TAPE GOES PER-NAME — and the ordering matches the CEPI decomposition, not a unif
- `2026-08-08` `L3779` Addendum 2026-08-08 ~11:45pm PDT — THE CHART BEHIND THE PASTE: assessor RESOLVED, the numbers DATED 7/28, and the past
- `2026-08-09` `L3823` Addendum 2026-08-09 ~12:35pm PDT — SWEEP #1 ON THE CDS TAPE: the origin is NAMED, the fresh print does NOT exist yet —
- `2026-08-10` `L3842` 2026-08-10 ~12:25am PDT — THE CURRENT SOURCE ARRIVES: WSJ's Q2 BDC-filings analysis — strain CONFIRMED in filed number
- `2026-08-10` `L3909` 2026-08-10 ~8:35am PDT — 13F FRIDAY (8/14): PRE-REGISTERING WHAT THE BATCH CAN AND CANNOT SHOW ABOUT THE TRS QUESTION
- `2026-08-10` `L3955` 2026-08-10 ~9:40am PDT — HEADLINE FLASH: "WALL STREET FIRMS, NVIDIA PARTNER ON $500B AI FINANCING DEAL: FT" — and NVDA
- `2026-08-10` `L4007` Addendum 2026-08-10 ~10:45am PDT — JAKE CLOSES THE CIRCLE ON THE $500B ENTRY: NVDA's FOUR ROLES against one counterpar
- `2026-08-10` `L4039` 2026-08-10 ~11:20am PDT — THE SNIPPET DELIVERS THREE OBJECTS: Huang's quote gets its venue, NVDA's OWN 50/50 re-segmen
- `2026-08-10` `L4099` Addendum 2026-08-10 ~12:35pm PDT — THE $500B FETCH RETURNS SAME-DAY (ZH full piece, Jake upload): CONSORTIUM NAMED — a
- `2026-08-10` `L4141` Addendum 2026-08-10 ~12:50pm PDT — WIRE CONFIRMATION + A SECOND PROGRAM: "MORGAN STANLEY TO FACILITATE UP TO $1.5T OVE
- `2026-08-10` `L4184` Addendum 2026-08-10 ~1:00pm PDT — JAKE REBUTS THE REWEIGHTING, AND THE RULE REFINES: "conflicted doesn't mean anything
- `2026-08-10` `L4211` Addendum 2026-08-10 ~1:10pm PDT — JAKE: "this is corroboration — that typically requires GUARANTEES that probably are 
- `2026-08-10` `L4242` ⛔ Correction 2026-08-10 ~1:20pm PDT — JAKE'S WORD WAS "AREN'T" VISIBLE (autocorrect, again) — THE READING INVERTS AND 
- `2026-08-10` `L4271` Addendum 2026-08-10 ~1:40pm PDT — FINK ON TAPE: the convener CONFIRMED, "raise as fast as possible," and the two-ledge
- `2026-08-10` `L4314` Addendum 2026-08-10 ~1:50pm PDT — THE FLOWS-LEDGER PERSONIFIED: retail bull reads the Fink tape ("we did not even star
- `2026-08-10` `L4338` Addendum 2026-08-10 ~2:15pm PDT — HUANG'S HALF OF THE TAPE: $50-60B PER GIGAWATT (the conversion factor), "investable.
- `2026-08-10` `L4393` Addendum 2026-08-10 ~3:45pm PDT — SONNET FETCH #1 RETURNS: both Huang quotes VERBATIM-CONFIRMED (Dwarkesh, April 15 20
- `2026-08-10` `L4431` 2026-08-10 ~4:10pm PDT — THE PRIMARY DOCUMENT LANDS (Huang's X post): THE WRAP GOES VISIBLE AT ≤25% RVG — Jake's test 
- `2026-08-11` `L4508` 2026-08-11 ~7:45am PDT — GRADED: the sign-flip test HELD TO THE CLOSE — and the $2T day closed FLAT
- `2026-08-11` `L4520` 2026-08-11 ~7:45am PDT — ★★★★ REGISTERED ITEM #2 CLOSES FROM THE OTHER SIDE: IBM's CEO PUT A NUMBER ON THE COMPUTE SHA
- `2026-08-11` `L4622` 2026-08-11 ~10:40pm PDT — ★★★★★ THE WSJ PRIMARY ON THE $500B PIPELINE: the mechanism is a RESIDUAL-VALUE GUARANTEE, no
- `2026-08-11` `L4694` 2026-08-11 ~10:55pm PDT — ★★★★★ THE COLLATERAL DISANALOGY, AND WHY THE 25% IS PROBABLY AN ACCOUNTING NUMBER RATHER THA
- `2026-08-11` `L4750` 2026-08-11 ~11:10pm PDT — ★★★★ "IS IT CO-SIGNING? CAN THEY DICTATE THE PROCEEDS? SOUNDS ILLEGAL" — GRADED: wrong on fo
- `2026-08-11` `L4795` 2026-08-11 ~11:20pm PDT — ⛔⛔ JAKE SPLITS "CIRCULAR" FROM "VENDOR FINANCING" AND HE IS RIGHT. This note has been import
- `2026-08-11` `L4844` 2026-08-11 ~11:30pm PDT — ★★★★★ "IT TURNS A SIGNATURE INTO CASH FLOW. WITHOUT ISSUING ANY DEBT." — the whole structure
- `2026-08-12` `L4888` 2026-08-12 ~12:05am PDT — ★★★★ RECEIVER WINDOW #1 GRADED: CRWV's PRINT IS A BACKLOG STORY THE EQUITY MARKET BOUGHT AND
- `2026-08-12` `L4939` 2026-08-12 ~11:55am PDT — ★★★★★ THE $9B PREPAYMENT LINE IS A THIRD FUNDING CHANNEL THIS VAULT HAS NOT BEEN TRACKING — 
- `2026-08-12` `L4987` 2026-08-12 ~9:45pm PDT — ⛔ "CORROBORATION AND HUANG DOUBLES DOWN" — IT IS NOT CORROBORATION. ONE ORIGIN, TWO OUTLETS, 
- `2026-08-12` `L5062` 2026-08-12 ~9:50pm PDT — ★★★★★ REGISTERED ITEM #3 CLOSED: THE A100 RATE CURVE, FETCHED. **I WAS WRONG ABOUT ITS MAGNIT
- `2026-08-12` `L5146` 2026-08-12 ~9:55pm PDT — ★★★★★ JAKE'S QUESTION COLLAPSES THE RATE PROBLEM TO **ONE DISCLOSED NUMBER** — and the identi
- `2026-08-12` `L5211` 2026-08-12 ~10:05pm PDT — ⛔ JAKE SUPPLIES THE **TRANSACTED** ANCHOR I SAID WAS MISSING — and taking it at face value d
- `2026-08-12` `L5273` 2026-08-12 ~10:15pm PDT — ★★★★★ JAKE LINKS META-COMPUTE TO THE RATE CURVE AND ASKS FOR A DEPRECIATION CLIFF. **THE VAU
- `2026-08-12` `L5369` 2026-08-12 ~10:20pm PDT — ⚠️ THE DEMAND-CONSTRAINT EVIDENCE: **ALL THREE NUMBERS WERE ALREADY ON DISK, TWO OF THEM FOR
- `2026-08-12` `L5438` 2026-08-12 ~10:30pm PDT — ★★★★★★ JAKE'S EFFICIENCY CHALLENGE BREAKS MY GRID ARGUMENT AND PRODUCES THE BEST RESULT OF T
- `2026-08-12` `L5511` 2026-08-12 ~10:50pm PDT — ⛔⛔⛔ **I RAN THE FALSIFIER I REGISTERED 15 MINUTES AGO AND IT KILLED MY OWN HEADLINE FINDING.
- `2026-08-12` `L5567` 2026-08-12 ~10:55pm PDT — ⛔ JAKE'S TIMING CLAIM TESTED AGAINST THE ONE REAL SERIES: **MID-2025 IS WHEN H100 PRICES *FE
- `2026-08-12` `L5632` 2026-08-12 ~11:00pm PDT — ★★★★★★ JAKE'S SEGMENTATION POINT BREAKS MY SUBSTITUTION CLIFF — **AND NAMES THE TENANT BASE 
- `2026-08-12` `L5689` 2026-08-12 ~11:05pm PDT — ⚠️ THE HUANG ATTRIBUTION, RESOLVED HONESTLY — and the vault's own disclosure record CONTRADI
- `2026-08-12` `L5737` 2026-08-12 ~11:15pm PDT — ⛔⛔ NO, THE STARTUP LINE IS NOT IN THERE — **AND THIS VAULT INGESTED AND GRADED THIS EXACT TR
- `2026-08-12` `L5794` 2026-08-12 ~11:15pm PDT (cont.) — ⛔ JAKE SOURCES IT HIMSELF: **WSJ, THIS WEEK — "many of his customers can't afford to
- `2026-08-12` `L7091` THE ONE SIX-YEAR GPU SERIES THE VAULT OWNS — `:L4996`, fetched 2026-08-12
- `2026-08-13` `L5841` 2026-08-13 ~12:52pm PDT — ★★★★★★★ **THE IDENTITY RESOLVES, AND IT RESOLVES AGAINST THE HIGH-RATE BRANCH.** Plus the de
- `2026-08-13` `L5928` 2026-08-13 ~12:55pm PDT — ⛔★ **MY PREDICTED SIGNAL IS ABSENT AND THE REAL ONE IS 12× BIGGER.** NVDA's DSO is FALLING —
- `2026-08-13` `L6009` 2026-08-13 ~10:00pm PDT — ★★★★★★ JAKE OPENS A THIRD DEPRECIATION CHANNEL THE VAULT HAS NEVER CONSIDERED: **REGULATORY 
- `2026-08-13` `L6098` 2026-08-13 ~10:10pm PDT — ⛔ **MY OBSTACLE 1 IS DEFEATED, AND ARITHMETIC DOES IT: PUE HAS 9% OF HEADROOM LEFT AT THE FR
- `2026-08-13` `L6104` DATA (REPORTED — industry PUE, verified 2026-08-13 ~10:15pm)
- `2026-08-13` `L6171` 2026-08-13 ~10:26pm PDT — ★★★★★★★ JAKE'S HAMSTER-WHEEL / VERTICAL-CURVE ARGUMENT: the "wolf" insight is a STANDING con
- `2026-08-13` `L6250` 2026-08-13 ~10:52pm PDT — ⛔★★★★★★★ THE DURATION TEST IS RESOLVED AND IT RESOLVES AGAINST THIS THREAD'S STANDING TONE: 
- `2026-08-13` `L6319` 2026-08-13 ~11:05pm PDT — ★★★★★★★ THE ACCOUNTING MOVED OPPOSITE TO THE PHYSICS, IN THE SAME WINDOW: NVDA HALVED ITS PR
- `2026-08-14` `L6411` 2026-08-14 ~3:55pm PDT — ★★★★★★★ THE CAUSALITY INVERTS: THE $500B WAS NOT A LAUNCH, IT WAS A **RESPONSE TO STALLED DEA
- `2026-08-14` `L6475` 2026-08-14 ~4:25pm PDT — ★★★★★★★ IT CANNOT SHOW SITUATIONAL AWARENESS — BUT IT SHOWS SOMETHING BIGGER: **JANE STREET O
- `2026-08-16` `L6540` 2026-08-16 ~9:00pm PDT — ★★★ WSJ PUTS **$3 TRILLION** OF OFF-BALANCE-SHEET AI COMMITMENTS ON THE FRONT PAGE. **JAKE: "
- `2026-08-17` `L6607` 2026-08-17 ~9:10am PDT — ★★★★★★ THE OHIO BACKSTOP IS ~$105B AND IT DOES NOT FIT NVIDIA'S OWN DISCLOSED CAP. ⇒ EITHER T
- `2026-08-17` `L6618` [2026-08-17] **OpenAI + SB Energy + NVIDIA announce the "PORTS-Pike" AI campus, Pike County, Ohio.**
- `2026-08-17` `L6621` [2026-08-17] **Initial backstop exposure reported ~$105B** — *"rather than a simple blanket guarantee of
- `2026-08-17` `L6623` [2026-08-17] Also confirmed in the brief, already vault-held: **Stripe/OpenRouter >$7B** (`compression-thesis:2205`),
- `2026-08-17` `L6681` 2026-08-17 ~9:40am PDT — ⛔⛔★★★★★★ JAKE'S PER-GW QUESTION KILLS MY $420B — **THE VAULT HELD THE DENOMINATOR SINCE 7/26 
- `2026-08-18` `L6748` 2026-08-18 ~1:10pm PDT — ✅✅ **THE OHIO ⬜ CLOSES ON NVIDIA'S OWN ANNOUNCEMENT, AND THE ARITHMETIC LANDS ON THE CAP: 4.2
- `2026-08-18` `L6756` [2026-08-18] **NVIDIA is exclusive AI-compute infrastructure provider for SB Energy's Ohio project:
- `2026-08-18` `L6759` [2026-08-18] **NVIDIA's announcement emphasises the infrastructure relationship and a $1.5B EQUITY
- `2026-08-18` `L6761` [2026-08-18] **The "$105B" is graded QUALIFIED: *"media reporting discussed financing or guarantees
- `2026-08-19` `L6795` 2026-08-19 ~7:30am PDT — ★★★★★★ **MARVELL ISSUES GOOGLE A $12.18B WARRANT TO WIN TPU-ECOSYSTEM SILICON. ⇒ THE CIRCULAR
- `2026-08-19` `L6860` 2026-08-19 ~4:25pm PDT — ⭐⭐⭐⭐⭐⭐ **HIS QUESTION IS ANSWERABLE AND I WENT AND ANSWERED IT FROM SEC PRIMARY — AND THE HEA
- `2026-08-20` `L6940` 2026-08-20 ~1:10pm PDT — ★★★★★★ **BROADCOM IS IN TALKS FOR UP TO $100B — "THE LARGEST SPV DEAL EVER FUNDED" — AND IT W
- `2026-08-21` `L7013` 2026-08-21 ~8:15am PDT — ⛔⭐⭐⭐⭐⭐ **THE AVGO DEAL IS NOT NEW — IT IS THE SECOND TRANCHE OF A PLATFORM THIS VAULT ALREADY
- `2026-08-21` `L7085` 2026-08-21 ~8:45am PDT — ★★★★★★ **JAKE'S 2030 TIPPING-POINT READ IS RIGHT BY A BETTER ROUTE THAN HE STATED, AND THIS V
- `2026-08-22` `L7154` 2026-08-22 ~9:00am PDT — ⛔⛔⛔ **THE "$220B vs $12.5B, 17.6×" HEADLINE IS A YEAR-OVER-YEAR COMPARISON, AND THE VAULT'S O
- `2026-08-22` `L7218` 2026-08-22 ~1:35pm PDT — ⛔ **POOLSIDE IS A MAP GAP, AND THE REASON MATTERS: NVDA ANNOUNCED A $1B INVESTMENT IN IT AT A
- `2026-08-23` `L7278` 2026-08-23 ~4:55pm PDT — 🚩🚩🚩 **A CLAIM THAT WOULD RE-EXPLAIN THE WHOLE AI EQUITY MOVE, REGISTERED AND NOT ENDORSED: "T
- `2026-08-23` `L7339` 2026-08-23 ~5:40pm PDT — ⛔⛔⛔ **THE CHART ARRIVES LEGIBLE AND IT FALSIFIES ITS OWN CAPTION AT BOTH ENDS.** ★★★★★★ **PHA
- `2026-08-24` `L7411` 2026-08-24 ~11:20pm PDT — 🕳️ **JAKE ASKS THE POLICY-PUT QUESTION AND THE VAULT HAS NO ENTRY FOR IT: WHAT IF TREASURY/T
- `2026-08-25` `L7474` 2026-08-25 ~10:25pm PDT — ⭐⭐⭐⭐⭐ **THE WALTER INVESTIGATION IS ARROW 1 OF A CHAIN THIS NOTE HAS HELD SINCE MAY 22 FINAL
- `2026-08-26` `L7542` 2026-08-26 ~4:20pm PDT — ⭐⭐⭐⭐⭐ **ANTHROPIC × NSCALE WEST VIRGINIA: $45B / 6 YEARS FOR 460MW OF VERA RUBIN — AND THE AR
- `2026-08-26` `L7581` 2026-08-26 ~9:45pm PDT — ⭐⭐⭐⭐⭐ **JAKE COMPLETES HIS 8/24 POLICY-PUT QUESTION INTO A FULL DESIGN: A TREASURY-DEMAND STA
- `2026-08-26` `L7637` Addendum 2026-08-26 ~9:52pm PDT — **JAKE'S REFINEMENT FLIPS THE CDS LEG AND DISSOLVES COUNTER #1: TREASURY IS THE PROT
- `2026-08-26` `L7664` Addendum 2026-08-26 ~10:00pm PDT — **JAKE'S SECOND REFINEMENT: THE HEDGE LEG'S CONVEXITY *IS* THE WAR CHEST — as sprea
- `2026-08-27` `L7683` 2026-08-27 ~3:12pm PDT — ⛔⛔⭐⭐⭐⭐⭐ **IREN: THE PERIPHERY'S FINANCING MECHANICS IN FULL DAYLIGHT — Jake's line adopted as
- `2026-08-28` `L7714` Addendum 2026-08-28 ~9:50am PDT — ⭐⭐⭐⭐ **IREN RESULTS + FINANCING STACK (8/28 scan): the GPU-financing rate ladder pri
- `2026-08-29` `L7745` 2026-08-29 ~8:55am PDT — ⭐⭐⭐⭐⭐ **IREN 10-K (SEC-filed, 8/29 scan): THE PERIPHERY CONSOLIDATES ITS SPV WHILE THE CORE D
- `2026-08-30` `L7787` 2026-08-30 ~10:05am PDT — ⭐⭐⭐⭐⭐ **JAKE'S QUESTION — "are they taking profits and GTFO while they can?" — ANSWERED WITH
- `2026-08-31` `L7862` Addendum 2026-08-31 ~12:38pm PDT — **the conveyor gains its RETIREMENT LEG and a hidden-leverage flag (Class B sweep, 
- `2026-08-31` `L7864` Addendum 2026-08-31 ~1:28pm PDT — ⭐⭐⭐⭐ **LAMBDA'S $926M GPU-BACKED SPV TERM LOAN B (8/31 scan tail): the first INVESTM
**2026-09**
- `2026-09-01` `L7880` Addendum 2026-09-01 ~1:22pm PDT — ⭐⭐⭐⭐ **THE LADDER'S TOP RUNG WAS ABSORBED BY A SPONSOR (9/1 close scan, xAI→SpaceX d
- `2026-09-02` `L7882` 2026-09-02 ~8:18am PDT — ⭐⭐⭐⭐ **CAPITAL ACCESS IS BIFURCATED, MEASURED (9/2 opening scan): global convertible issuance
- `2026-09-03` `L7884` 2026-09-03 ~7:25am PDT — **GPU LADDER, CRWV RUNGS FILLED IN (Q2 10-Q via 9/3 scan):** CRWV carries THREE fixed rungs (
- `2026-09-03` `L7886` 2026-09-03 ~8:45am PDT — ⭐⭐⭐⭐ **F2 STEPS UP FROM SLOWER INFLOWS TO OUTRIGHT REDEMPTION: "CLIFFWATER PRIVATE CREDIT FUN
- `2026-09-03` `L7895` Addendum 2026-09-03 ~8:55am PDT — **F17 (Anthropic IPO) — the risk factor is REAFFIRMED by the Pentagon a day after Co
- `2026-09-04` `L7897` Addendum 2026-09-04 ~7:05am PDT — **CAPITAL FORMATION IS STILL ACCELERATING, AND THE ROUND SHAPE IS THE TELL: GIMLET L
- `2026-09-04` `L7899` 2026-09-04 ~1:30pm PDT — ⭐⭐⭐⭐⭐⭐ **THE DISPERSION INSTRUMENT ARRIVES: 300bp ON IDENTICAL COLLATERAL, INSIDE ONE ISSUER'
- `2026-09-05` `L7910` Addendum 2026-09-05 ~9:00am PDT — ⭐⭐⭐⭐⭐⭐ **JAKE'S CROWD-OUT CALL IS CONFIRMED AND DATED (8/15) — BUT THE SPREAD DATA S
- `2026-09-05` `L7944` Addendum 2026-09-05 ~11:40am PDT — ⛔⭐⭐⭐⭐⭐⭐ **THE ORDER-BOOK DATA EXISTS AND IT CORRECTS ME TWICE: THE INDEX WAS HIDING
- `2026-09-07` `L7980` 2026-09-07 ~8:15am PDT — ⭐⭐⭐⭐⭐ **IREN, QUANTIFIED FROM THE FUNDING SIDE: "UP TO $30B BY JUNE 2027" AGAINST $7.6B CASH 
- `2026-09-08` `L7999` 2026-09-08 ~6:45am PDT — ⭐⭐⭐⭐⭐⭐ **THE LABS ARE TRYING TO CROSS FROM STRUCTURED CREDIT INTO THE IG BOND MARKET: BANKERS
- `2026-09-08` `L8014` 2026-09-08 ~8:40am PDT — ✅⭐⭐⭐⭐⭐⭐ **QUALCOMM×AMAZON IS THE THIRD "WARRANTS-FOR-VOLUME" DEAL AND THE VAULT PRE-REGISTERE
- `2026-09-08` `L8038` 2026-09-08 ~2:55pm PDT — ⭐⭐⭐⭐⭐⭐ **THE FT DETAIL THAT CHANGES HOW THIS NOTE READS NVDA'S LARGEST EXPOSURE: THE $105B SB
- `2026-09-08` `L8052` 2026-09-08 ~9:50pm PDT — ⭐⭐⭐⭐⭐⭐ **THE VAULT'S NAMED BLIND SPOT IS BEING REBUILT WHILE WE WATCH: GS FICC SAYS REAL-MONE
- `2026-09-08` `L8083` Addendum 2026-09-08 ~10:15pm PDT — ⛔⛔ **I CORRECT THE ENTRY I WROTE TWENTY MINUTES AGO, AND THE CORRECTION IS WORTH MO
- `2026-09-08` `L8126` Addendum 2026-09-08 ~10:35pm PDT — ⛔⛔ **THE SAME PASTE, READ PROPERLY: THAT CDS QUOTE IS NOT A STANDALONE ANECDOTE. IT
- `2026-09-08` `L8150` 2026-09-08 ~11:20pm PDT — ⭐⭐⭐⭐⭐⭐⭐ **THE CHARTS BEHIND THE TWEETS, AND THEY OVERTURN TWO OF TONIGHT'S THREE CONCLUSIONS
- `2026-09-08` `L8188` Addendum 2026-09-08 ~11:30pm PDT — ⛔⛔ **AND THE SECOND IMAGE IS THE 8/6 GS FCF CHART AT FULL RESOLUTION, WHICH EXPOSES
- `2026-09-09` `L8199` 2026-09-09 ~7:05am PDT — ⭐⭐⭐⭐⭐⭐ **THE PERIMETER HOLE I FLAGGED LAST NIGHT CLOSES IN TWELVE HOURS, AND IT CLOSES IN THE
- `2026-09-09` `L8215` 2026-09-09 ~7:50am PDT — ⭐⭐⭐⭐⭐⭐⭐ **THE VAULT NOW HOLDS FOUR "PAYBACK PERIODS" FOR THE SAME ASSET CLASS SPANNING **ONE 
- `2026-09-09` `L8237` Addendum 2026-09-09 ~8:10am PDT — **QCOM GETS ITS GUIDANCE, AND IT REFRAMES THE VAULT'S OWN "~$6B/YR" — THE AVERAGE IS
- `2026-09-09` `L8245` 2026-09-09 ~8:35am PDT — ⭐⭐⭐⭐⭐ **THE YEN CHANNEL IS NOT A NEW BLIND SPOT — JAKE REGISTERED IT MONTHS AGO AND THE VAULT
- `2026-09-09` `L8263` Addendum 2026-09-09 ~10:10am PDT — **THE GOOGLE CLOUD BACKLOG ⬜ I CALLED "THE HIGHEST-VALUE FETCH ON THIS ITEM" AT 7:5
- `2026-09-09` `L8269` 2026-09-09 ~2:20pm PDT — ⭐⭐⭐⭐⭐⭐⭐ **THE MONITOR'S BIGGEST NUMBER IS ONE NOBODY IN IT DECOMPOSES: **70% OF NVIDIA'S $22.
- `2026-09-09` `L8293` 2026-09-09 ~5:15pm PDT — ⭐⭐⭐⭐⭐⭐⭐ **THE VAULT ALREADY HOLDS THE Q1 13F, SO HALF THE AUTHOR'S NOVEMBER TEST IS ANSWERABL
- `2026-09-11` `L8316` 2026-09-11 ~9:15pm PDT — ⭐⭐⭐⭐⭐⭐⭐ **BofA PUTS AN INDEX ON THE VAULT'S CENTRAL CALL — AND IT IS **PROGRESSION, NOT CONFI
- `2026-09-12` `L8359` Addendum 2026-09-12 ~9:00am PDT — ⭐⭐⭐⭐⭐ **THE CIRCULARITY GAINS ITS **THIRD** INSTANCE AND ITS FIRST AT **IPO-EQUITY**
- `2026-09-12` `L8382` Addendum 2026-09-12 ~9:45am PDT — ⭐⭐⭐⭐⭐ **THE DENOMINATOR ARRIVES. THE BOARD HAS BEEN ARGUING ABOUT ANTHROPIC-AS-COUNT
- `2026-09-13` `L8402` 2026-09-13 ~11:15am PDT — ⭐⭐⭐⭐⭐⭐ **A $50 BILLION ANTHROPIC COMPUTE COUNTERPARTY THE VAULT HAS **NEVER RECORDED** — `gr
- `2026-09-13` `L8435` Addendum 2026-09-13 ~11:25am PDT — ⭐⭐⭐⭐⭐⭐⭐⭐ **JAKE IS RIGHT AND IT IS **THE SAME COMPANY, THREE DAYS AGO: THE PENTAGON
- `2026-09-13` `L8463` Addendum 2026-09-13 ~11:45am PDT — ✅⭐⭐⭐⭐⭐⭐⭐⭐ **THE CHECK I REGISTERED 30 MINUTES AGO IS SCORED, AND I WENT TO THE 10-Q
- `2026-09-13` `L8503` Addendum 2026-09-13 ~6:30pm PDT — ⭐⭐⭐⭐⭐ **GOLDMAN SUPPLIES THE HIGH-YIELD TIER, AND THE TWO-DESK PICTURE IS NOW COMPLE
- `2026-09-14` `L8517` Addendum 2026-09-14 ~8:55am PDT — ⭐⭐⭐⭐ **MONDAY'S REPRICING, SCORED (settled per rule 22, entered once): A DISCOUNT-RA
- `2026-09-14` `L8524` 2026-09-14 ~5:20pm PDT — ⭐⭐⭐⭐⭐⭐⭐ **THE EVENING SCAN DELIVERS THE AGGREGATE AND CLOSES YESTERDAY'S ⬜ (settled per rule 
- `2026-09-16` `L8545` 2026-09-16 ~6:40pm PDT — ⭐⭐⭐⭐⭐ **THE TRANSMISSION BEGINS FROM THE BOTTOM: HY/BB/B +6bp WITH IG PINNED AT 80 — AND AI-S
- `2026-09-16` `L8556` 2026-09-16 ~7:15pm PDT — ⭐⭐⭐⭐ **FDIC CHART 7: BANK UNREALIZED LOSSES $326.7B, GROWING TWO STRAIGHT QUARTERS — AS OF JU
- `2026-09-19` `L8565` 2026-09-19 ~12:30pm PDT (covers Thu-Fri; settled per rule 22) — ⭐⭐⭐⭐⭐⭐ **THE FUNDING-SIDE WEEK: THE ORCL GUARANTEE SEN
- `2026-09-19` `L8579` 2026-09-19 ~10:10pm PDT — ⭐⭐⭐⭐⭐⭐ **THE $3.1T DECOMPOSED PER COMPANY (MORGAN STANLEY) · A REPORTED $500B NVDA CHIP FACI
