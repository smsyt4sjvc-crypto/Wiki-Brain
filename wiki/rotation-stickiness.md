...
> **7 dated entries · 2026-07-03 → 2026-08-18 · refreshed 2026-08-25 17:28 PDT**
>
...
**2026-07**
- `2026-07-03` `L30` DATA — the triggering scan (2026-07-03, candle scan, `tools/flow_trackers.py`-style)
- `2026-07-07` `L79` Update 2026-07-07 — the rotation reached the SECOND RANK (evidence FOR sticky)
- `2026-07-10` `L99` Update 2026-07-10 — record tech insider BUYING (against-the-bear ledger, honest entry)
- `2026-07-10` `L111` Update 2026-07-10 PM — the semi Form-4 grid RESOLVES the insider puzzle (searches, verified)
- `2026-07-11` `L168` 2026-07-11 — GS Prime book: the hedge-fund layer prints (Jake paste)
**2026-08**
- `2026-08-12` `L183` 2026-08-12 ~8:40pm PDT — ★★★★ QUARTERLY REGIME GAUGE, FIRST REAL RUN: NOTHING PREDICTS THE NEXT QUARTER, AND "WHICH AR
- `2026-08-18` `L249` 2026-08-18 ~4:00pm PDT — ⛔⛔ **"HEDGE FUNDS ARE DOUBLING DOWN" IS A LEVEL/FLOW ERROR READ OFF THE CHART'S OWN AXIS: THE
