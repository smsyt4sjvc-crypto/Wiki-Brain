...
> **105 dated entries · 2026-05-22 → 2026-08-28 · refreshed 2026-08-28 09:45 PDT**
>
...
**2026-05**
- `2026-05-22` `L381` Burry "Heretic's Guide Part III" — the bezzle/tokenmaxxing/compression frame (source 2026-05-22)
**2026-06**
- `2026-06-04` `L332` AVGO Stage-1.5 datapoint — "maintain not raise" (earnings 2026-06-04)
**2026-07**
- `2026-07-01` `L166` ⚡ Scarcity crack goes LIVE (2026-07-01 AM) — the thesis inflecting
- `2026-07-01` `L195` Jul-1 close — the crack in the tape (added 2026-07-01 PM)
- `2026-07-01` `L228` "Tokenmaxxing" goes institutional — CEPI confirmed from a CEO (2026-07-01)
- `2026-07-01` `L239` Memory shortage — confirmed & worsening (added 2026-07-01)
- `2026-07-02` `L221` Jobs data = real-economy vote on flush-vs-regime → "not yet" (2026-07-02)
- `2026-07-02` `L481` DATA — empirical anchor: Virginia Digital Gateway KILLED (2026-07-02, `raw/2026-07-02-qts-virginia-digital-gateway-kil
- `2026-07-03` `L284` ⚠️ ROI crack ≠ spend crack — the timing relocation (2026-07-03)
- `2026-07-05` `L417` ROI crack — the COST side (memory + political friction) (2026-07-05, Jake's angle)
- `2026-07-05` `L423` DATA (verified WebSearch 2026-07-05)
- `2026-07-05` `L457` ⚡ The political constraint is a BIPARTISAN RATCHET, not partisan noise (2026-07-05, Jake — "the deepest point")
- `2026-07-05` `L494` DATA — the broader wave (WebSearch 2026-07-05; QTS article sidebars)
- `2026-07-05` `L505` THESIS (deepened — 2026-07-05)
- `2026-07-05` `L525` All-in $/compute — the ground-up capital-efficiency question (2026-07-05, Jake)
- `2026-07-05` `L530` DATA (verified WebSearch 2026-07-05)
- `2026-07-07` `L264` Contract mechanics — the LTA floor question (2026-07-07, Jake's Q)
- `2026-07-07` `L554` Global derate — the cycle-top signature (2026-07-07, Jake)
- `2026-07-07` `L584` 2026-07-07 cluster — enclosure + the lawsuit (both verified)
- `2026-07-07` `L652` DATA (`raw/2026-07-07-wiki-log-jul6-7.md`)
- `2026-07-08` `L651` 2026-07-08 ingest — the GS capex series + the cliff, redefined (from Jake's Jul-6/7 log)
- `2026-07-08` `L673` 2026-07-08 — Apple executes the whale-repricing move (ONE day after the vault predicted it)
- `2026-07-09` `L695` 2026-07-09 — the Meta reframe: landlord, not blinker (Jake's synthesis)
- `2026-07-10` `L723` 2026-07-10 — Bernstein: 12 years to clear the 338 GW pipeline (up from 10 LAST MONTH)
- `2026-07-10` `L740` 2026-07-10 — the cost side reaches the CONSUMER: pass-through table + electricity forwards (GS)
- `2026-07-10` `L741` DATA (`raw/2026-07-10-zh-memory-pce-electricity.md` — GS via ZH, reported)
- `2026-07-10` `L779` 2026-07-10 — Williams (NY Fed) names AI demand as his top inflation focus; 9 hike dots
- `2026-07-10` `L789` 2026-07-10 PM — the Token Revolt goes mainstream + a possible spend-plateau print
- `2026-07-10` `L790` DATA (as-reported, `raw/2026-07-10-zh-feed-token-revolt.md`)
- `2026-07-10` `L810` 2026-07-10 late — Trump pumps MU: 3 Truth posts <1hr celebrating the NY fab
- `2026-07-11` `L830` 2026-07-11 — SK Hynix CEO's eternal-shortage call, and the article that refutes it
- `2026-07-12` `L859` 2026-07-12 — memory-cycle history answered (Jake: "will memory have another cycle? did they
- `2026-07-12` `L872` 2026-07-12 UPDATE to the MU-pump read — Trump OWNS Micron (verified, OGE 278-T filings)
- `2026-07-12` `L892` 2026-07-12 — BofA Exhibit 6: the FCF transfer, quantified — hyperscalers NEGATIVE, semis $430B
- `2026-07-12` `L930` 2026-07-12 — Apple v. OpenAI detail (extends the whale's-third-front entry)
- `2026-07-12` `L950` 2026-07-12 — week-ahead sensors + SKH raise size (Reuters week-ahead)
- `2026-07-12` `L955` 2026-07-12 eve — SKHY workup (Jake: "relatively quiet" — the quiet IS the datapoint)
- `2026-07-12` `L989` 2026-07-12 eve — THE LISTING CLUSTER (Jake's thesis: the incentives line up across all of them)
- `2026-07-12` `L1030` 2026-07-12 eve — Samsung PULLS FORWARD the supply wave: Yongin fab #1 to 2029 (from 2030-31)
- `2026-07-12` `L1031` DATA (`raw/2026-07-12-samsung-yongin-accel-honam.md`, ChosunBiz 7/12)
- `2026-07-12` `L1058` 2026-07-12 late — the margin-redistribution thesis: the bull case and the bear case are the SAME EVENT
- `2026-07-12` `L1059` DATA (`raw/2026-07-12-margin-redistribution-thread-korea-bonds.md`)
- `2026-07-12` `L1134` 2026-07-12 late — Jake's HORIZONTAL-BUILD discriminator: Jevons AND Burry both right; the question
- `2026-07-12` `L1180` 2026-07-12 — SemiAnalysis: the "50% canceled" number was phantom; the buildout is INTACT
- `2026-07-12` `L1181` DATA (`raw/2026-07-12-semianalysis-dc-cancellation-debunk.md`, SemiAnalysis 6/18, satellite Vision Model)
- `2026-07-12` `L1252` 2026-07-12 ~10pm PT — OpenAI CONFIRMS the GPT-5.6 nerf: shrinkflation for cognition
- `2026-07-13` `L1099` 2026-07-13 ~2am — THE TOKEN-SPEND CHART: the labs' revenue proxy is −21% from the May peak
- `2026-07-13` `L1100` DATA (`raw/2026-07-13-silicon-data-token-expenditure-index.md`, Silicon Data chart upload)
- `2026-07-13` `L1223` 2026-07-13 ~3:45am — Jake's pincer hypothesis: China release-restrict + NVDA open-source = coordinated?
- `2026-07-13` `L1273` 2026-07-13 ~10:40am PT — MU −5.0% to $930 (Jake's screen): the memory complex reprices TOGETHER
- `2026-07-13` `L1287` 2026-07-13 ~10:45am PT — the memory-cycle CLOCK, made explicit (Jake: "how long do these last?")
- `2026-07-13` `L1305` 2026-07-13 ~11:45am PT — JAKE'S RETAIL SENSOR FIRES (first sighting) + the $2T capex race
- `2026-07-13` `L1322` 2026-07-13 ~12pm PT — THE MEMORY SENSOR PANEL goes live (Jake's DigiKey BOM + the SSD sighting)
- `2026-07-14` `L1342` 2026-07-14 ~4:05am PT — IBM PRE-ANNOUNCES a miss; the CEO line is the thesis: "capex reprioritization"
- `2026-07-14` `L1444` 2026-07-14 ~4:25am PT — ERICSSON: memory cost-push casualty #2, and the pass-through mechanism
- `2026-07-14` `L1445` DATA (observed) — raw/2026-07-14-ericsson-memory-margin-warning.md
- `2026-07-14` `L1479` 2026-07-14 ~4:42am PT — IBM full letter RESOLVES the crux: REALLOCATION via memory front-running
- `2026-07-14` `L1526` 2026-07-14 ~6:18am PT — Jake's MU "second leg": the BURIED memory signal = a real informational edge
- `2026-07-14` `L1555` 2026-07-14 ~7:06am PT — DEEPSEEK preparing IPO filing "as soon as this year" (ZH)
- `2026-07-14` `L1571` 2026-07-14 ~8:25am PT — MAG7 workbook TOKEN ECONOMICS: the Jevons-vs-deflation debate, resolved
- `2026-07-14` `L1572` DATA (observed — with sources; see raw/2026-07-14-mag7-fcf-capex-token-workbook.md)
- `2026-07-14` `L1590` 2026-07-14 ~9:20am PT — AI's PHYSICAL talent-hub footprint: SF/NYC office absorption (Jake's early call)
- `2026-07-14` `L1656` 2026-07-14 ~7pm PT — CXMT prices $10B IPO: the memory SUPPLY response arrives (MU-thesis threat)
- `2026-07-14` `L1687` 2026-07-14 ~11:25pm PT — China Huawei/SwaySure DRAM complex: the GLUT supply-wave, coordinated (Jake: "Glut")
- `2026-07-15` `L1719` 2026-07-15 ~7:14am PT — ASML raises guidance 2nd time (buildout demand strong NEAR-term) + PYPL M&A
- `2026-07-15` `L1737` 2026-07-15 — Beige Book (July): the capex boom is in the REAL economy, and it's the whole beam
- `2026-07-16` `L1773` 2026-07-16 — IBM inside story (WSJ): capex CANNIBALIZATION confirmed + first insider ROI-doubt (Cohn)
- `2026-07-20` `L1795` 2026-07-20 ~1:50pm PT — Google "Frozen v2": model baked into silicon = the Jevons/Burry crux, physical
- `2026-07-29` `L1823` 2026-07-29 ~1:10pm PT — ★★★ META: REVENUE GUIDE **BELOW** CONSENSUS + CAPEX FLOOR **RAISED**. THE RAZOR'S PUREST FORM.
- `2026-07-29` `L1874` 2026-07-29 ~10:55pm PT — ★★★ THE $130B LEASE LINE: the capex conflict I refused to resolve is resolved, and BOTH headl
- `2026-07-30` `L1911` 2026-07-30 ~10:40am ET — META AT A 52-WEEK LOW: the bear case is this vault's own line, and the bull case has a TEMPLA
- `2026-07-31` `L1950` 2026-07-31 ~8:50am PT — ★★★★★ A SITTING FED PRESIDENT NAMED DATA CENTERS AS AN INFLATION SOURCE
- `2026-07-31` `L1981` 2026-07-31 ~11:35am PDT — JAKE'S LOCAL-DEMAND LEG — and ⛔ the vault had a Fed VOTER on this A MONTH before Kashkari
- `2026-07-31` `L2029` 2026-07-31 ~8:22pm PT — TRUMP ON CAMERA: "we're leading China in AI by a lot" (Huang standing behind him)
- `2026-07-31` `L2093` Addendum 2026-07-31 ~8:40pm PT — ★★ THE AI ADVISORY COUNCIL: who has the President's ear, and who does NOT
- `2026-07-31` `L2099` DATA (as-reported — web search 2026-07-31 ~8:35pm PT)
**2026-08**
- `2026-08-03` `L2136` 2026-08-03 ~8:35am PDT — ★★★ THE ISM RESPONDENT COMMENTS: FIRST **SUPPLY-SIDE** CONFIRMATION OF THE BUILDOUT — and the
- `2026-08-03` `L2248` Addendum 2026-08-03 ~9:15am PDT — ⟲ THE 7/31 "EXCLUSIONS" FINDING WAS TOO STRONG. Two channels, and the labs hold the 
- `2026-08-04` `L2275` 2026-08-04 ~1:20pm PDT — ★★★★ SPACEX Q2: AI CAPEX $15.8B/QTR AGAINST $2.6B OF AI REVENUE — the cleanest CEPI specimen 
- `2026-08-04` `L2346` Addendum 2026-08-04 ~2:06pm PDT — STARMIND AI-1: one rack in orbit, announced into the earnings cycle
- `2026-08-05` `L2382` Addendum 2026-08-05 ~12:45pm PDT — ⛔ SPACEX IS A PUBLIC COMPANY, AND THE 8/4 TABLE WAS ITS FIRST EARNINGS REPORT — the
- `2026-08-06` `L2450` Addendum 2026-08-06 ~12:20pm PDT — ⛔ SPCX TRADES 18-20% BELOW ITS IPO — the 8/5 "~$1.98T (~$149/sh)" line was WRONG; t
- `2026-08-11` `L2471` 2026-08-11 ~11:05am PDT — ★★★★★ F19 RESOLVES ON THE SHELL LEG, AND IT GOES AGAINST MY FRAMING: DATA-CENTRE CONSTRUCTIO
- `2026-08-11` `L2539` 2026-08-11 ~11:40am PDT — ★★★★ JAKE'S INVERSION QUESTION, TESTED: IT DOES INVERT AND THE FAB CYCLE IS ~4.8 YEARS — but
- `2026-08-11` `L2607` 2026-08-11 ~12:15pm PDT — ⛔⛔ THE FAB "COLLAPSE" IS A SHELL→TOOL-IN PHASE CHANGE, NOT AN INVESTMENT DECLINE. Jake caugh
- `2026-08-15` `L2663` 2026-08-15 ~2:02pm PDT — ⭐⭐⭐ JAKE'S SHARED-DEPENDENCY HYPOTHESIS IS CONFIRMED WITH DISCLOSED REVENUE SHARES — and the 
- `2026-08-15` `L2765` 2026-08-15 ~2:05pm PDT — ⭐⭐⭐ THE AI-ADJUSTED BREADTH REPORT: the framework is right and the best statistic in it is no
- `2026-08-15` `L2861` 2026-08-15 ~2:14pm PDT — ★★★★★★★ HE GENERALISES A MECHANISM THIS VAULT ALREADY HAS REGISTERED — **"the crowd-out loop"
- `2026-08-15` `L2920` 2026-08-15 ~3:00pm PDT — ⛔⛔ HE CORRECTS MY "VOLUME LARGELY SURVIVES" FROM 45 MINUTES AGO, AND THE 2000 DATA I FILED TH
- `2026-08-15` `L2982` 2026-08-15 ~3:08pm PDT — ★★★★★★★ "OR FINANCING PULLED BACK" IS NOT A FIFTH ITEM ON THAT LIST — IT IS A DIFFERENT CLASS
- `2026-08-19` `L3036` 2026-08-19 ~7:03am PDT — ✅ **F1 CLOSES. THE 7/29 READ AT `:1859` WAS RIGHT AND IS NOW UNAMBIGUOUS: THE VALIDATION SUPP
- `2026-08-19` `L3054` 2026-08-19 ~7:05am PDT — ⛔ **F3 DOWNGRADED, AND IT IS A REAL DE-ESCALATION: THE CXMT/YMTC "WALL" IS A BIPARTISAN *LETT
- `2026-08-19` `L3072` 2026-08-19 ~2:10pm PDT — ✅⛔⭐⭐⭐⭐⭐ **JAKE DISSOLVES MY ZIRP COUNTEREXAMPLE AND HE IS RIGHT — BUT ZIRP *DID* HAVE A DEBT-
- `2026-08-19` `L3143` 2026-08-19 ~2:25pm PDT — ⛔⭐⭐⭐⭐⭐⭐ **HE IS RIGHT AND IT MAKES THE PRECEDENT *WORSE* FOR AI, NOT BETTER: SHALE HAD NO DEM
- `2026-08-20` `L3203` 2026-08-20 ~8:40am PDT — ⛔⛔★★★★★★ **THE PORTFOLIO TAKEAWAY IS THE EXACT INVERSE OF THIS NOTE'S OWN THREE-CYCLE CONTROL
- `2026-08-20` `L3274` 2026-08-20 ~8:55am PDT — ⛔⛔⭐⭐⭐⭐⭐ **THE MRVL "$12.2 BILLION" IS THE EXERCISE *COST*, NOT VALUE — intrinsic is ~$2.28B. 
- `2026-08-20` `L3331` 2026-08-20 ~9:15am PDT — ✅⭐⭐⭐⭐⭐ **JAKE IS RIGHT: THE VAULT CALLED THIS ON 2026-07-05 AND CALLED IT *BIPARTISAN* EXPLIC
- `2026-08-20` `L3420` 2026-08-20 ~10:05am PDT — ⛔⛔⛔ **MY OWN CONTRA-REVENUE SIZING FROM YESTERDAY WAS WRONG BY ~12× AND THE CONCLUSION FLIPS
- `2026-08-22` `L3500` 2026-08-22 ~9:00am PDT — **ON/SYNAPTICS S-4: THE HEADLINE IS 12% DILUTION, BUT THE NUMBER THE FILING ACTUALLY DISCLOSE
- `2026-08-26` `L3543` 2026-08-26 ~3:55pm PDT — ⭐⭐⭐⭐⭐⭐ **NVDA Q2 FY27 — THE DEMAND HALF: $96.2B (+4.3% beat, +106% y/y) · DC $89.0B · Q3 GUID
- `2026-08-26` `L3567` Addendum 2026-08-26 ~7:12pm PDT — ⭐⭐⭐⭐⭐⭐ **CALL FOLLOW-THROUGH, AND JAKE NAMES THE NEW PIECE CORRECTLY: 70% FY28 IS TH
- `2026-08-26` `L3588` Addendum 2026-08-26 ~8:13pm PDT — **AWS DECOMPOSITION + TAPE:** the +2M GPUs are INCREMENTAL to a prior 1M+ AWS plan s
- `2026-08-27` `L3590` 2026-08-27 ~3:10pm PDT — ⭐⭐⭐⭐⭐ **MRVL: THE DEMAND RATCHET CONTINUES — $2.739B (+37% y/y), DC $2.172B (+46% y/y, 79% of
- `2026-08-27` `L3603` Addendum 2026-08-27 ~4:09pm PDT — ⭐⭐⭐⭐ **THE MACRO-SHARE DATUM: HIGH-TECH CAPEX (equipment + software + R&D) = 55.2% O
- `2026-08-28` `L3621` Addendum 2026-08-28 ~9:50am PDT — **MRVL: the selloff's stated cause CONFIRMS the filed structure rather than contradi
