...
> **83 dated entries · 2026-07-25 → 2026-09-10 · refreshed 2026-09-17 16:41 PDT**
>
...
**2026-07**
- `2026-07-25` `L146` 2026-07-25 ~10:35pm PT — Jake's Q: reserve-supplied consumption = "already paid for"? How it actually lands in XOM/CVX
- `2026-07-28` `L172` 2026-07-28 ~11:56am PT — THE REFINER TAPE (Jake's watchlist): the crack trade has ALREADY PAID — and it is long a gove
- `2026-07-30` `L204` 2026-07-30 ~4:55pm PT — ★★★ "SEABORNE MARKET = US" (Jake) — CORRECT ON GAS, WRONG ON CRUDE, AND THE SPLIT IS THE FINDI
**2026-08**
- `2026-08-09` `L244` 2026-08-09 ~9:35am PDT — VENEZUELA AS THE REPLACEMENT BARREL: the value-chain claim is structurally right, and it coll
- `2026-08-09` `L290` Addendum 2026-08-09 ~9:40am PDT — ★★★★ THE FETCHES CLOSE IN AN HOUR — and they carry a fact bigger than the Venezuela 
- `2026-08-13` `L330` 2026-08-13 ~8:55am PDT — ★★★★★★ THE DIESEL CRACK CLOSES THE FLAG `war-board:1762` REGISTERED ("crack spreads = the gau
- `2026-08-13` `L334` DATA (computed from futures, Yahoo chart API, 2026-08-13 ~9:00am PDT — HO×42 − WTI)
- `2026-08-13` `L398` 2026-08-13 ~11:45am PDT — ⛔⛔⛔ TWO CORRECTIONS TO MY OWN 8:55am ENTRY, BOTH VERIFIED — **a mislabelled window, and a DE
- `2026-08-13` `L403` DATA (recomputed 2026-08-13 ~1:10pm PDT)
- `2026-08-13` `L465` 2026-08-13 ~12:00pm PDT — ⛔⛔ JAKE'S ULSD-BACKWARDATION ARGUMENT **DEFEATS MY DECOUPLING FINDING** — I measured a SPOT 
- `2026-08-13` `L474` DATA (ULSD + WTI futures curves, pulled 2026-08-13 ~11:55am PDT)
- `2026-08-13` `L542` 2026-08-13 ~12:25pm PDT — 📡 FETCH #1 BACK (global product supply): **JAKE'S PREMISE #4 IS UNDERSTATED, NOT JUST CONFIR
- `2026-08-13` `L631` 2026-08-13 ~1:40pm PDT — 📊 JAKE'S REFINER RANKING, **TESTED BY REGRESSION: THREE OF HIS FOUR LABELS CONFIRMED** — and 
- `2026-08-13` `L636` DATA (regression, 2026-08-13; β = % stock move per $1 crack move; R² = share of daily variance explained)
- `2026-08-13` `L695` 2026-08-13 ~1:45pm PDT — ⛔ DECLINED (rule 7): a 1-5 confidence score on 90-day return per name is a RATING. **But the 
- `2026-08-13` `L746` 2026-08-13 ~2:00pm PDT — ✅ **"IS THERE ROOM TO RUN ON CRACKS?" — ANSWERED. ESTIMATES HAVE NOT FINISHED MARKING: 24 of 
- `2026-08-14` `L831` 2026-08-14 ~6:10pm PDT — ⛔ I HANDED JAKE HIS OWN EDGE BACK AS HIS RISK. **The collapsing deferred strip is not the dis
- `2026-08-14` `L871` DATA (MEASURED — CME/NYMEX settlements, trade date 2026-08-14, unless flagged)
- `2026-08-14` `L1769` DATA (MEASURED — EIA WPSR, w/e 2026-08-14, released 2026-08-19)
- `2026-08-15` `L863` 2026-08-15 ~12:44am PDT — ⛔⛔⛔ THE TRIGGER I REGISTERED LAST NIGHT HAD ALREADY FIRED FIVE WEEKS EARLIER — **Russia bann
- `2026-08-15` `L950` 2026-08-15 ~12:57am PDT — ★★★★★★ THE INDEPENDENT CROSS-CHECK EARNS ITS KEEP: it **closes a long-standing registered op
- `2026-08-15` `L1046` 2026-08-15 ~1:00am PDT — ⛔⛔⛔ THE SECOND CROSS-CHECK ATTACKS THE THESIS AT ITS CORE: **84% of the three-month crack exp
- `2026-08-15` `L1121` 2026-08-15 ~2:05am PDT — ⛔⛔ MY 84% FINDING IS WINDOW-DEPENDENT AND THE RECENT WINDOW REVERSES IT: **over the last mont
- `2026-08-17` `L1183` 2026-08-17 ~8:11am PDT — 🚩 STATE READ ON JAKE'S Q: **"still room?"** — **THE MECHANISM IS INTACT, THE EASY MONEY IS GO
- `2026-08-17` `L1234` 2026-08-17 ~8:16am PDT — ⛔⛔⛔ **I MADE THE WINDOW ERROR THIS NOTE HAS ALREADY LOGGED TWICE, AND IT REVERSED MY ANSWER.*
- `2026-08-17` `L1288` 2026-08-17 ~8:25am PDT — ✅ **THE DEFERRED STRIP, FETCHED AT LAST** (the ⬜ registered since 8/15 and never closed) — an
- `2026-08-18` `L1337` 2026-08-18 ~9:00am PDT — ⛔⛔ "RECORD $102 / ABSOLUTELY UNPRECEDENTED" IS FALSE AND THIS NOTE ALREADY KILLED IT ON 8/15.
- `2026-08-18` `L1387` 2026-08-18 ~9:30am PDT — 📌 PBF INSIDER SALES: JAKE PULLED THE FORM 4s AND HIS READ SURVIVES ARITHMETIC CHECK. ⇒ **THRE
- `2026-08-18` `L1452` 2026-08-18 ~9:50am PDT — ✅⛔ **THE NIMBLEY ITEM IS CLOSED AND IT CLOSES BENIGN. JAKE PULLED TABLE II: BOTH SALES WERE E
- `2026-08-18` `L1501` 2026-08-18 ~10:10am PDT — ✅🚩🚩🚩 **THE NAMED BREAK CONDITION IS FETCHED AT LAST (open since 8/13) AND IT SPLITS: LEVEL C
- `2026-08-18` `L1570` 2026-08-18 ~11:05am PDT — ⭐⭐⭐⛔ **THE BRIDGE SERIES LANDS AND IT PARTLY REVERSES MY OWN DISCONFIRMER FROM THIS MORNING:
- `2026-08-18` `L1626` 2026-08-18 ~11:30am PDT — ⭐⭐⭐⭐ **RETAIL DIESEL LANDS (the flag open since 8/18 ~9:00am) AND IT PRODUCES THE SHARPEST N
- `2026-08-18` `L1680` 2026-08-18 ~1:20pm PDT — ⚠️⚠️ **A THIRD-PARTY VERIFICATION BRIEF GRADES "DIESEL CRACK AT AN ALL-TIME HIGH ~$102.20" AS
- `2026-08-19` `L1710` 2026-08-19 ~8:05am PDT — ⛔⛔ **THE RUSSIAN SHORTAGE IS A *GASOLINE* SHORTAGE, AND THAT CUTS *AGAINST* THE CRACK POSITIO
- `2026-08-19` `L1763` 2026-08-19 ~8:20am PDT — ★★★★★★ **BOTH DECISIVE SERIES RESOLVED IN ONE PRINT AND BOTH LAND ON THE POSITION'S SIDE: ref
- `2026-08-23` `L1843` 2026-08-23 ~7:05am PDT — ⛔⛔⛔ **JAKE'S Q: "IF BRENT TANKS, CRACKS JUMP RIGHT? DENOMINATOR DOWN?" — THERE IS NO DENOMINA
- `2026-08-23` `L1884` ★★★★★★ THE BASE RATE, WITH ITS n AND ITS WINDOW (2026-08-23 pull; 486 matched sessions, 2024-08-23 → 2026-08-21; roll-
- `2026-08-23` `L1973` 2026-08-23 ~7:35am PDT — ✅✅✅ **THE 12-MONTH DEFERRED STRIP LANDS AND CLOSES THE #1 REGISTERED ITEM (open since 8/17).*
- `2026-08-23` `L2083` 2026-08-23 ~7:40am PDT — 🔧 **TOOL DEFECT FOUND AND FIXED: `librarian.py`'s MAGNITUDE-COLLISION CHECK WAS BLIND TO EVER
- `2026-08-23` `L2106` 2026-08-23 ~8:05am PDT — ⛔⛔⛔ **JAKE: "AND YOU DO HAVE OUR FULL REFINERY BRANCH RIGHT? WE WENT OVER THIS EXTENSIVELY LA
- `2026-08-23` `L2211` 2026-08-23 ~11:15pm PDT — 🚩🚩🚩 **THE REFINER THESIS HAS THREE PHYSICAL DISCRIMINATORS AND ZERO POLITICAL ONES — AND A P
- `2026-08-26` `L2262` 2026-08-26 ~4:35pm PDT — ⭐⭐⭐⭐⭐⭐ **THE DIVERGENCE THE VAULT FALSIFIED FOR JULY IS NOW LIVE IN AUGUST, WITH ITS CAUSE AT
- `2026-08-26` `L2308` Addendum 2026-08-26 ~4:40pm PDT — ⭐⭐⭐⭐⭐⭐ **JAKE PULLS THE WPSR HIMSELF AND THE REFINER TEST CLOSES CONFIRMED — STRONGE
- `2026-08-28` `L2331` Addendum 2026-08-28 ~10:00am PDT — **STREET-LEVEL PRIMARY (Jake's photo, Conoco/Jacksons, Thierman & Broadway, SPOKANE
- `2026-08-28` `L2352` 2026-08-28 ~4:50pm PDT — ⭐⭐⭐⭐⭐ **TRUMP ANNOUNCES "THE BIGGEST OIL DEAL IN WORLD HISTORY" (Truth Social, 3:47pm ET): "m
- `2026-08-28` `L2420` Addendum 2026-08-28 ~4:55pm PDT — ✔⛔ **CORROBORATION RUN (Jake: "check for corroboration"; source = Trump's VERIFIED T
- `2026-08-28` `L2456` 2026-08-28 ~5:25pm PDT — ⭐⭐⭐⭐⭐ **PRE-REPO BACKFILL: THE VENEZUELA THREAD, JANUARY→JUNE (Jake's recall from the origina
- `2026-08-28` `L2523` Addendum 2026-08-28 ~7:35pm PDT — ✔⭐⭐⭐⭐⭐ **SECOND-PARTY CONFIRMATION (Jake: official Venezuelan government statement, 
- `2026-08-29` `L2553` 2026-08-29 ~12:40pm PDT — ⭐⭐⭐⭐ **GOLDMAN CODIFIES THE DIVERGENCE — WITH A 2027 DATE ON IT (Jake's brief, "higher for l
- `2026-08-31` `L2587` Addendum 2026-08-31 ~7:25am PDT — **THE WAR PREMIUM ARRIVES ON SCHEDULE: Brent +5.9% to ~$91.21, WTI +3.5% to ~$86.33 
- `2026-08-31` `L2589` Addendum 2026-08-31 ~7:45am PDT — ⛔⭐⭐⭐⭐⭐ **THE CAMPAIGN SIGNATURE PRINTS: US DIESEL CRACK APPROACHING $100/BBL while B
- `2026-08-31` `L2592` Addendum 2026-08-31 ~10:30am PDT — ⭐⭐⭐⭐ **THE KILL-SWITCH'S SECOND FIRING ALSO SPARES THE CRACK (Jake's brief): EPA gr
**2026-09**
- `2026-09-01` `L2619` 2026-09-01 ~9:42am PDT — ⛔⭐⭐⭐⭐⭐ **A STORM IS AIMED AT THE BOTTLENECK: TROPICAL STORM EDOUARD ~90mi SE of PORT ARTHUR, 
- `2026-09-01` `L2620` DATA (ZH/NHC, `raw/2026-09-01-zh-feed-scan.txt`)
- `2026-09-01` `L2627` Addendum 2026-09-01 ~9:44am PDT — ⭐⭐⭐⭐ **BESSENT SAYS THE ENDGAME ALOUD: HORMUZ WILL BE A "WORTHLESS PIECE OF WATER" I
- `2026-09-01` `L2632` Addendum 2026-09-01 ~9:50am PDT — **Jake's Q: "When does Venezuela relieve Brent?" — answered (rule 14 shape), and the
- `2026-09-01` `L2634` 2026-09-01 ~11:05am PDT — ⛔⭐⭐⭐⭐⭐⭐ **THE CAMPAIGN SIGNATURE BREACHES $100 AND KEEPS GOING: NYMEX 1-MONTH HEATING-OIL/CR
- `2026-09-01` `L2647` Addendum 2026-09-01 ~1:05pm PDT — ⭐⭐⭐⭐⭐ **THE CONVERSION-CAPACITY REGIME GETS ITS MEASURED DENOMINATOR (Goldman/Struyv
- `2026-09-01` `L2649` 2026-09-01 ~4:15pm PDT — ⛔⭐⭐⭐⭐⭐⭐ **THE KILL-SWITCH FIRES A THIRD TIME — AND SPARES THE CRACK A THIRD TIME. White House
- `2026-09-02` `L2664` 2026-09-02 ~7:50am PDT — ⭐⭐⭐⭐ **EIA WEEKLY (Jake): CRUDE −4.45MM vs +60K expected · gasoline −1.17MM · distillates +79
- `2026-09-02` `L2670` 2026-09-02 ~8:20am PDT — **VENEZUELA WILL NOT REFILL THE SPR (Jake: said "at the G20," speaker ⬜ — filed as recollecti
- `2026-09-02` `L2672` Addendum 2026-09-02 ~8:35am PDT — ✅⭐⭐⭐⭐ **THE SPR-REFILL QUESTION, SOURCED (extends 8:20am): the G20 speaker Jake reca
- `2026-09-02` `L2677` 2026-09-02 ~8:45am PDT — ⭐⭐⭐ **Two corroborations (ZH scan):** (1) **"Feedstock is not fuel" (Karl Miller via Larry Jo
- `2026-09-02` `L2679` Addendum 2026-09-02 ~9:10am PDT — ⭐⭐⭐⭐⭐ **THE EIA PRINT WITH ITS CHARTS (ZH PDF via Jake, `raw/2026-09-02-zh-eia-wti-5
- `2026-09-02` `L2685` Addendum 2026-09-02 ~9:15am PDT — **Jake's Q: "Can Venezuelan crude be traded for sweeter crude for the SPR?" — YES me
- `2026-09-02` `L2687` Addendum 2026-09-02 ~9:20am PDT — ✅ **Jake's arithmetic on the SPR swap (adopted; corrects my 9:15am price objection):
- `2026-09-03` `L2689` Addendum 2026-09-03 ~7:30am PDT — **RETAIL DIESEL $5.783 (Wednesday, highest since mid-2022, "approaching a record"); 
- `2026-09-03` `L2691` Addendum 2026-09-03 ~8:50am PDT — **THE SAME EIA WEEK (ended Aug 28) IN WSJ'S NUMBERS (Harrup, raw/2026-09-03-wsj-eia-
- `2026-09-03` `L2693` 2026-09-03 ~3:15pm PDT — ✅⭐⭐⭐⭐⭐⭐ **THE REGISTERED REVERSAL TRIGGER RESOLVES — FAVORABLY, AND IT CLOSES: THE WHITE HOUS
- `2026-09-04` `L2717` 2026-09-04 ~7:05am PDT — ⭐⭐⭐⭐⭐⭐ **THE THROUGHPUT DISCRIMINATOR FIRES, AND DIESEL TAKES THE RECORD: 4 VISIBLE HORMUZ CR
- `2026-09-04` `L2727` Addendum 2026-09-04 ~7:20am PDT — ⭐⭐⭐⭐⭐⭐ **THE WORLD'S LARGEST TANKER OPERATOR JUST DATED THE DISRUPTION AND NAMED ITS
- `2026-09-04` `L2736` Addendum 2026-09-04 ~2:20pm PDT — **THE DIESEL RECORD IS CONFIRMED AT $5.85 (surpassing the June 2022 peak) — AND GOLD
- `2026-09-04` `L2743` REFERENCE 2026-09-04 ~3:30pm PDT — **WHAT "BRENT" ACTUALLY IS, AND WHY THE VAULT'S DIFFERENTIAL RULE FOLLOWS FROM IT (
- `2026-09-04` `L2753` 2026-09-04 ~3:35pm PDT — ✅⭐⭐⭐⭐⭐⭐ **THE ⬜ REGISTERED FIVE MINUTES AGO PRINTS: THE GRADE STACK HAS INVERTED. MIDDLE EAST
- `2026-09-04` `L2781` Addendum 2026-09-04 ~3:45pm PDT — **TWO ⬜ CLOSED AGAINST PRIMARIES, AND BOTH GO AGAINST ME: THE BYPASS IS NOT FULL, IT
- `2026-09-07` `L2866` Addendum 2026-09-07 ~8:15am PDT — **JAZAN HIT AGAIN (REPORTED) — THE 9/4 ELIGIBILITY SPLIT NOW HAS A RED-SEA-SIDE CAVE
- `2026-09-07` `L2870` Addendum 2026-09-07 ~8:30am PDT — **RETAIL: GASOLINE $4.14/gal NATIONAL AVERAGE, ~+$1 y/y, A LABOR DAY RECORD (AP/AAA)
- `2026-09-07` `L2872` Addendum 2026-09-07 ~8:30am PDT — **STREET-LEVEL, SECOND READING (Jake's GasBuddy screenshot, Spokane 99201, DIESEL, "
- `2026-09-07` `L2878` 2026-09-07 ~8:10pm PDT — ⭐⭐⭐⭐⭐⭐ **REUTERS: BUNKER FUEL IS THE THIRD PRODUCT TO GO SHORT, AND THE NUMBER REUTERS PRINTS
- `2026-09-07` `L2900` ⛔ CORRECTION 2026-09-07 ~8:15pm PDT — **THE FULL REUTERS TEXT (Jake's paste, `raw/2026-09-07-reuters-ship-fuel-shortag
- `2026-09-09` `L2919` 2026-09-09 ~7:20am PDT — ⭐⭐⭐⭐⭐⭐ **DECOMPOSE THE PUMP BEFORE READING IT (RULE 20), AND THE RECORD IS NOT THE STORY — TH
- `2026-09-10` `L2940` 2026-09-10 ~7:15pm PDT — ⛔⭐⭐⭐⭐⭐⭐⭐ **APPEC (Vitol + KPC) SAYS THE DIESEL CRUNCH WORSENS — AND IT IS *LITERALLY* THIS MO
- `2026-09-10` `L2977` 2026-09-10 ~7:30pm PDT — ⛔⛔⭐⭐⭐⭐⭐⭐⭐ **JAKE, TWICE IN FIVE MINUTES: *"RUSSIA'S DECREE IS CAUSED BY REFINERY CONSTRAINT T
...
3. ~~🚩🚩 **GULF PRODUCT-EXPORT VOLUMES (Ruwais / Jubail / Ras Tanura / Al-Zour), not hull counts.**~~ ✔ **PARTLY CLOSED 2026-09-07 8:10pm (Reuters): Al-Zour 191k → 26k bpd fuel oil; ME fuel-oil exports −45% y/y to 447k bpd. Ruwais/Jubail/Ras Tanura still ⬜.**
...
### 2026-09-02 ~8:20am PDT — **VENEZUELA WILL NOT REFILL THE SPR (Jake: said "at the G20," speaker ⬜ — filed as recollection pending the quote).** If so, the SPR clock (287M, ~one month to the record low; 7:50am entry) is a PERMANENT retirement of the crude-side kill-switch lever, not a pause: Venezuelan barrels go to refineries and the market (the fact sheet's own plumbing), not the reserve. Consequence for the basket: reinforces feedstock-to-refiners; and it means that after ~October the administration's remaining tools are Venezuela (slow), jawboning, and product-side measures — the export-restraint disconfirmer's probability inside the window keeps rising as the SPR runs out. Grades hold; the SPR date stays on the re-grade watch. **📌** the G20 quote (who said it; verbatim) · SPR weekly.

### Addendum 2026-09-02 ~8:35am PDT — ✅⭐⭐⭐⭐ **THE SPR-REFILL QUESTION, SOURCED (extends 8:20am): the G20 speaker Jake recalls is still ⬜, but the substance is settled three ways — and it lands on the basket's side.** (1) **TRUMP SAYS IT WILL:** "One of the things I am going to do with the Venezuelan Oil is fill up the Strategic National Reserves… a Gift from Venezuela to the People" (Aug 30/Sept 1; SPR ~290M, lowest since the 1980s). (2) **PHYSICS SAYS IT CAN'T:** Venezuelan extra-heavy crude "doesn't meet the specifications of the crude that is stored in the caverns" (Sternoff, Columbia CGEP); "physically and chemically incompatible with the operating design of the SPR" (Misra, Texas A&M); DOE's own prior finding: "storing heavy oil would present considerable operational difficulties"; Capital Economics: could "cause damage to the underground caverns." Timing: "at least two years, if not five to seven" for Orinoco production to reach any reserve (Goldwyn). (3) **THE WHITE HOUSE'S OWN PLUMBING SAYS REFINERIES:** Aug 28 — "millions of barrels of new Venezuelan output will be processed through US refineries," with a US right to buy 20% at cost; Wright: refining capacity is "the biggest kink."
- **NEW MEASURED NUMBER (Under Secretary of Energy Kyle Haustveit, Aug): >500,000 b/d already moving Venezuela → US, ≈40% of Venezuela's 1.25M b/d national output.** ⇒ This morning's "routing, not net supply" read has its figure: the redirect is ~500K b/d and already happening; the EIA weekly Venezuela-import meter now has a baseline to beat. Venezuela's total output 1.25M (vs the ~0.9-1M carried this morning — precision update).
- **Read (analysis):** whoever said it at the G20, the SPR will not be refilled with Venezuelan barrels — not by policy choice but by cavern chemistry — and the President's statement is the claim, the physics is the fact. The crude-side kill-switch lever (SPR) retires ~October with no Venezuelan replenishment; Venezuelan heavy goes where the fact sheet said and where the cokers are. **Basket implication unchanged and firmer: feedstock to Gulf refiners, not to the reserve; SPR exhaustion pushes the remaining policy tools toward the product side (the watch).** The 20%-at-cost purchase right is a new detail — the US government as a below-market crude buyer is itself a lever (a quasi-SPR by contract rather than cavern).
**📌** the G20 quote (speaker ⬜) · EIA weekly Venezuela imports vs the 500K baseline · the 20%-at-cost mechanism (who takes delivery? DOE? refiners?).

### 2026-09-02 ~8:45am PDT — ⭐⭐⭐ **Two corroborations (ZH scan):** (1) **"Feedstock is not fuel" (Karl Miller via Larry Johnson): Venezuelan crude "is the wrong substance to fix the shortage Americans feel at the pump" — diluent/coker constraints; the 30-50M bbl floated is <half a day of global consumption; the 65B is in-ground, not supply; any price effect takes years.** = this morning's crack-before-benchmark read and the 9/1 timing answer, from an independent desk; and the political datum: gasoline $4.09, +27% y/y, "most expensive August on record," midterms two months out — the kill-switch's gasoline leg quantified. (2) **IRGC claims two tankers hit MINES Wednesday on an "illegal route"** (→ [[war/war-board]] 8:35am): if confirmed, product cracks get another Gulf-flow shock; the Bahri SIDR deaths (Monday, projectiles) are already the first commercial-shipping fatalities — war-risk premia reprice on deaths, not damage. Refinery basket: unchanged (the crack's drivers only get worse on either item).

### Addendum 2026-09-02 ~9:10am PDT — ⭐⭐⭐⭐⭐ **THE EIA PRINT WITH ITS CHARTS (ZH PDF via Jake, `raw/2026-09-02-zh-eia-wti-5wk-highs.pdf`; charts read): the 7:50am read was exact — total crude draw INCLUDING the SPR = −7,572K (−4,450 commercial −3,122 SPR). And four structural facts the text adds:** (1) **SPR 287M = LOWEST SINCE NOVEMBER 1982**, and the chart shows 2026's draw is the STEEPEST IN THE RESERVE'S HISTORY — weekly draws touched ~−10MM earlier this year (deeper than 2022's max), ~180MM drawn from the ~466M post-rebuild level; continuous weekly draws since ~April. (2) **US crude production 13,862 kb/d (8/28) = RECORD**, with the rig count 447, up from ~408 in June — the first supply response to $90 WTI, ~40 rigs in ten weeks. (3) **REFINERY RUNS AT A SEVEN-YEAR HIGH — Midwest at an ALL-TIME RECORD, Gulf Coast highest for the season.** (4) **EAST COAST DISTILLATE STOCKS AT RECORD LOWS; West Coast lowest since May 2025; heating season one month out; gasoline imports 370K b/d, below 2020 levels.** Rasmussen (Global Risk Management): "the market is now clearly pricing in a direct military confrontation… a worse combination than April. Today, inventories are even more depleted."
- **THE REGIME'S DOMESTIC FORM (analysis):** global runs are −7 mb/d (GS) while US runs are at a seven-year high — the US refining system is at its CEILING, running everything it can into a $106 crack. That is the conversion-capacity constraint measured from the inside: no more throughput to add, so incremental margin comes from price, not volume. **For the basket: utilization is maxed (no volume upside left), which is precisely why the crack, not runs, is the earnings variable — and why the White House's "expand capacity" is a 2030 answer to a 2026 problem.**
- **THE SPR CLOCK, WITH ITS HISTORY (analysis):** lowest since 1982 and drawn at a record pace — the crude-side lever isn't just retiring in October, it has been the administration's primary crude tool all year (~180MM barrels ≈ the entire 2022 release again). When it hits tank bottoms the market loses ~3MM/week of hidden supply — a step-change tightening on top of the −4.45MM commercial draw. And the record-low East Coast distillate stock a month before heating season is the RETAIL political leg (Northeast heating oil) that the kill-switch's next firing will have to answer — with fewer crude-side tools.
- **THE PRODUCTION RECORD IS THE ONE DISCONFIRMER TO LOG:** 13,862 + 447 rigs rising is the price signal working on the crude side. It relieves CRUDE over quarters; it does nothing for the crack (the constraint is conversion, and runs are already maxed). The stated-vs-measured gap on "600K b/d since inauguration" sits inside this series.
**📌** rig count series (447 → ?) as the crude-supply response meter · East Coast distillate vs heating season (Oct 1) · SPR weekly to tank bottoms · runs vs the seven-year high (any outage = crack up, volume down — Edouard next week).

### Addendum 2026-09-02 ~9:15am PDT — **Jake's Q: "Can Venezuelan crude be traded for sweeter crude for the SPR?" — YES mechanically, NO inside the window.** Routes: (1) DOE EXCHANGE authority (EPCA; decades of crude-for-crude loans/returns) — deliver heavy to Gulf cokers, take back SPR-spec sour/sweet later + premium (the reserve is ~60% SOUR already; the disqualifier is HEAVY — 8-16° API won't pump through salt caverns — not sour); (2) monetize the 20%-at-cost purchase right and buy SPR-spec crude with the proceeds. **Why not in-window:** volume (~500K b/d flowing → 20% ≈ 100K → ~80K b/d SPR-equivalent after the heavy discount ≈ 0.55MM/wk vs a 3.1MM/wk draw and ~180MM to restore = ~6 years) · price (DOE's refill policy since 2023 = fixed-price forwards ~$67-79; no refill at $90+) · direction (any refill SUBTRACTS light barrels from the commercial market — the opposite of the "lower gas prices" objective; the two cannot run simultaneously; refill = post-price-goal or post-election). **Disconfirmer:** a DOE exchange/at-cost refill solicitation at current prices. **Basket:** a swap route = MORE Venezuelan heavy to the cokers + a wider heavy discount — feedstock economics improve either way (MPC/VLO/PBF). ⬜ the 20%-at-cost mechanics (who takes delivery; DOE or refiners).

### Addendum 2026-09-02 ~9:20am PDT — ✅ **Jake's arithmetic on the SPR swap (adopted; corrects my 9:15am price objection):** government buys Venezuelan heavy at ~$25 (cost) · heavy market ~$75 · SPR-spec sweet ~$90 ⇒ sell/swap the heavy at $75, add the ~$15 quality differential ⇒ **effective SPR acquisition cost ≈ $40, not $90** (= production cost + heavy/sweet differential + transport/transaction). The $50 cost-to-market gap is the value of the at-cost right — "the gift" — and the swap converts it into reserve barrels. ⛔ **Concession:** DOE's $67-79 refill-price policy is satisfied on an EFFECTIVE-cost basis at any market price, so "no refill at $90+" falls as an objection. **What stands:** VOLUME (100K b/d at cost ≈ 0.55MM/wk vs a 3.1MM/wk draw and ~180MM to restore ≈ 6 years) and DIRECTION (a swap still removes SPR-spec light barrels from the commercial market — cannot run alongside the price objective; post-price-goal or post-election). **The question his math surfaces — WHO CAPTURES THE $50:** at-cost cargoes to the cokers = a ~$50/bbl feedstock SUBSIDY (~$5M/day at 100K b/d; bullish basket, cheaper products) vs DOE exercising the right for the reserve = the cheapest feedstock leaves the refiners' slate. Pump or reserve; in-window, pump. Input refinements: $25 is a LIFTING cost — delivered Orinoco extra-heavy carries diluent/upgrading (⬜ all-in); the $15 differential WIDENS as heavy volume arrives, so effective cost drifts up with the volume that would make it matter. **📌** DOE exercise of the 20% right (delivery point = who captures) · Maya/Merey-WTI differential series.

### Addendum 2026-09-03 ~7:30am PDT — **RETAIL DIESEL $5.783 (Wednesday, highest since mid-2022, "approaching a record"); LNG STILL AT A STANDSTILL — Qatar/UAE resort to ship-to-ship LNG transfers (ZH scan 7:25am; Reuters/Vortexa/Kpler via OilPrice — raw/2026-09-03-zh-feed-bodies.txt).** Diesel: the national average is now above its early-war peak — **the kill-switch's political input (diesel headlines) at a new high for the war, six days after firing #3 spared the crack.** The pattern (n=3, all sparing the crack) holds until a product-export jawbone; the 9/1 refiner-summit readout stays the reversal trigger. LNG: three cargoes STS'd offshore Oman in August (GasLog Shanghai→Savannah; Al Rekayyat→Tembek, delivered India Aug 31; ADNOC Mraweh→LNG Enugu, to Japan) — "highly unusual" for LNG; Qatar's force majeure extended; **Asia spot LNG 5-month high; TTF 3.5-year high (€73.60)**; ING: "particularly if Qatari LNG remains largely absent through year-end." Read: crude Hormuz flows have rebounded on the shuttle/STS model; LNG cannot use it at scale — so the gas leg of the energy shock is the one with no release valve, and it is Europe's (Bunds/OATs at multi-year highs on TTF, ECB 3 hikes priced — [[rates-board]] today). Tape: Brent Nov $94-96 range after a 3-day rally; "crude up, fuel prices lower" this morning (a first crack-negative session — one day, not a trend); Putin's conciliatory tone knocked the complex; Novak: Russia to "slightly lower" 2026 output; Kazakhstan Aug +11% m/m. Trump on the renewed strikes: "will not continue for too long"; officials "pointed towards steady Strait of Hormuz flows." **GRADES (16c): refinery basket holds** (VLO 9 · MPC 9 · PBF 8 · PARR 8 · DINO 8 · PSX 7) — diesel at a war-high raises kill-switch odds but the firing pattern spares the crack; a declared "end" ([[war-board]] today) hits flat-price, not the product bind. ⬜ Edouard shut-ins in today's/next EIA · retail diesel record (2022 peak $5.816) · any product-export language from the summit.

### Addendum 2026-09-03 ~8:50am PDT — **THE SAME EIA WEEK (ended Aug 28) IN WSJ'S NUMBERS (Harrup, raw/2026-09-03-wsj-eia-weekly-aug28.txt) — precision adds to the 9/2 7:50am/9:10am entries; the new finding is the INVENTORY WEDGE.** Commercial crude 424.5M (−4.5M; **~1% ABOVE the five-year average**) · SPR 286.6M (−3.1M) · Cushing 22.5M (+80K) · production 13.86M (+19K) · imports 6.8M (+612K) · crude exports 4.5M (+691K) · **utilization 98% from 97.4% (survey expected −0.3pt); crude input 17.5M (+102K)** · gasoline 205.7M (−1.2M; **6% below 5-yr**), demand 8.9M (−121K) · distillate 104.2M (+796K vs −1.9M expected; **14% below 5-yr**). **★★★★ THE WEDGE IN INVENTORY FORM (analysis):** crude stocks are ABOVE normal while gasoline is 6% and distillate 14% BELOW normal with the system at 98% — the conversion-capacity regime stated as three inventory numbers: there is enough crude; there is not enough capacity to turn it into product, and the SPR has been the crude-side lever all year while the product side has none. The distillate build (the 9/2 "soft datum") sits inside a 14%-below-normal stock, so it is rationing at the price, not relief. Gasoline demand −121K at a record-August pump price = the same rationing on the other product. **Utilization at 98% means the next outage (Edouard, not yet in this week's data) is a product loss with no headroom to make it up** — that is the VLO Port Arthur flag from 9/1, and the peers' cracks move the other way. Crude exports +691K to 4.5M is the crude leaving that the refiners cannot run; a product-export restriction would be the jawbone that hits the basket, and crude exports rising is the opposite datum. **GRADES (16c): refinery basket holds** (VLO 9 · MPC 9 · PBF 8 · PARR 8 · DINO 8 · PSX 7). ⬜ next week's print with Edouard · the distillate series vs the 14% gap into Oct 1 · EIA Venezuela imports line (the policy meter).

## 2026-09-03 ~3:15pm PDT — ✅⭐⭐⭐⭐⭐⭐ **THE REGISTERED REVERSAL TRIGGER RESOLVES — FAVORABLY, AND IT CLOSES: THE WHITE HOUSE REFINER SUMMIT ASKED FOR *MORE CAPACITY*, NOT LOWER MARGINS (WSJ, Collin Eaton, `raw/2026-09-03-wsj-trump-refiners-summit-readout.pdf` + .txt)**
### DATA — what was actually asked for
- Trump urged executives **to BUILD MORE REFINERIES** to bring gasoline prices down before the November midterms. Discussed: **cutting regulations, speeding permitting, additional investments.** US official: *"The President made clear that he wants lower gas prices at the pump… The refiners and distributors shared that goal and commitment."*
- **The White House framed the Venezuela stake as REQUIRING more refining capacity** *"to absorb barrels as production comes online."*
- **In the room: Chevron, VALERO, MARATHON PETROLEUM, PBF ENERGY, among others. ExxonMobil — the nation's third-largest refiner — DID NOT SEND A REPRESENTATIVE.** Some companies were *"initially wary of attending, given Trump's recent attacks on the industry."*
- Pump: **$4.10/gal Tuesday (AAA), from $2.98 before the Iran conflict** = **+37.6%**.
### DATA — the industry's own numbers
- **Utilization >97% for recent weeks, near the highest in ~8 years** (WSJ/EIA). *(⬜ minor: the vault filed "7-year high" from the EIA charts 9/2 and 98% this week; WSJ says ~8 years. Logged, not reconciled.)*
- **Woods (Exxon, late July): *"The utilization that we've seen can't be sustained for the long term… I think this refining challenge is going to be with the world for a while."***
- **Diesel crack "recently hit a record above $100 a barrel."** **Top six US refiners earned a combined $24.7B on fuel-making in Q2 — nearly 5× a year earlier.**
- **⚠️ SOME COMPANIES ARE DEFERRING SCHEDULED MAINTENANCE to capture the margins.**
- **Building is uneconomic:** several billion dollars, **3-5 years** of construction. Campbell (Energy Aspects): *"Nobody's going to go out and make a huge multibillion-dollar investment based on three months of record margins."*
- **The structural picture: 128 FEWER refineries than in 1982; the newest completed 1977; ~a quarter built more than a century ago.** Auers (Novi Labs): expansion of existing Gulf Coast facilities could add **~400,000 b/d over the NEXT 20 YEARS** ≈ one large refinery. Capital is going the other way: **Exxon ~$2B at Baytown to make MORE diesel/lubricants and LESS gasoline starting 2028**; Chevron similar-but-smaller at Pascagoula; **Wirth: Chevron stays "more upstream-weighted."**
- **Trump's March claim — "America First Refining," Brownsville TX, first new US refinery in 50 years, a "$300 billion deal."** WSJ: the region lacks infrastructure to get sufficient crude there; financing and permits are both problems. **⚠️ THE NUMBER CANNOT BE RIGHT AS PRINTED: a large refinery costs single-digit billions; $300B is one to two orders of magnitude beyond the most expensive refinery ever built. Treat as a claimed headline figure, not a project cost.** ⬜ the actual filing/announcement.
### ✅ THE TRIGGER, RESOLVED
- **The registered reversal trigger for the refinery basket (set 9/1) was: THE REFINER SUMMIT READOUT.** The feared content was a **product-side intervention** — an export restriction, a price mechanism, a windfall levy, or a jawbone aimed at the crack. **None of it happened.** The ask was **supply expansion via deregulation and permitting** — i.e. the administration proposes to fix a shortage by making it easier to build the thing nobody will build. **Kill-switch firing #4, and the pattern holds at n=4: every intervention to date has landed on the CRUDE/FEEDSTOCK side and none on the PRODUCT MARGIN.** The EXIT BELL remains unrung: **the first product-export jawbone.**
- **★★★★★★ THE POLICY RESPONSE RATIFIES THE THESIS INSTEAD OF THREATENING IT (analysis):** the vault's oil regime is *conversion capacity is the constraint.* **The White House convened the industry, was told the constraint is real, and the only remedies on the table are 3-5 year builds and 20-year expansions totalling one refinery's worth of capacity.** Woods says the strain persists; Campbell says nobody will build on three months of margins; Auers says 400kb/d by 2046. **A bottleneck that the state has now formally examined and cannot relieve inside a decade is a stronger moat after the meeting than before it.** And the Venezuela framing makes it worse in the same direction: **more heavy crude arriving into a system with no spare conversion capacity widens the crude-to-product spread the basket earns.**
- **★★★★ THE ONE GENUINELY NEW RISK, AND IT IS NAME-LEVEL: DEFERRED MAINTENANCE.** Running >97% while pushing scheduled turnarounds out is a trade of present margin for future reliability. **It raises the probability of UNPLANNED outages in Q4-Q1 — and at 98% utilization there is no headroom to make up a lost unit (2:20pm/8:50am).** This is idiosyncratic, not systemic: it hits whichever operator's unit fails, while its peers' cracks widen on the outage. **For the basket it is not a thesis risk; it is a single-name accident risk that the current margins are actively manufacturing.** ⬜ turnaround-deferral disclosures in Q3 calls (late Oct-early Nov, already the in-window catalyst).
- **★★★ EXXON'S EMPTY CHAIR IS A DATUM (analysis):** the third-largest refiner skipped a White House meeting on refining while its CEO publicly says the strain persists and its capital goes to **diesel/lubricants at Baytown in 2028.** Read: the majors are pivoting product mix and weighting upstream rather than defending gasoline — **which removes the most credible source of new gasoline conversion capacity and leaves the merchant refiners (the basket) holding the scarce asset.** Not gradeable for XOM/CVX (not in the book).
### GRADES (16c) → [[grades]]
**THE BASKET HOLDS: VLO 9 · MPC 9 · PBF 8 · PARR 8 · DINO 8 · PSX 7. The trigger is CLOSED, not converted into an upgrade — and the reason matters: kill-switch firing #3 (9/1) ALREADY included the summit, and the 8→9 / 7→8 moves were taken on it. Upgrading again on the readout of the same event would be double-counting.** Grade discipline per 16c: the news is confirmation of the driver already priced into the move, plus one new name-level risk (deferred maintenance) pointing the other way. **Nothing here supports a 10 on a cyclical at all-time highs whose operators are trading maintenance for margin.**
**📌 REGISTERED:** ✅ CLOSED — "refiner summit readout as the basket's reversal trigger" (resolved favorably, n=4 sparing the crack) · **NEW: turnaround-deferral disclosures in Q3 calls, and any unplanned outage at a basket name** · the EXIT BELL still unrung (first product-export jawbone) · America First Refining's actual terms ⬜ · Baytown 2028 diesel conversion as a dated, beyond-window supply add · Venezuela barrels vs conversion capacity (the spread-widening mechanism).
**Links:** [[demand-destruction]] · [[new-economy-regime]] · [[portfolio-state]] · [[grades]] · [[forest]]

## 2026-09-04 ~7:05am PDT — ⭐⭐⭐⭐⭐⭐ **THE THROUGHPUT DISCRIMINATOR FIRES, AND DIESEL TAKES THE RECORD: 4 VISIBLE HORMUZ CROSSINGS THURSDAY vs 9 WEDNESDAY vs ~15 TEN-DAY AVERAGE; US DIESEL $5.85/gal, A RECORD, vs ~$3.76 PRE-WAR (open scan, Kpler/Reuters/AP)**
- **DATA — flow:** **4 visible commodity vessels crossed Thursday · 9 Wednesday · ~15 average over the prior ten days.** **Only TWO VLCC crossings all week** (Kpler). ⚠️ **AIS-dark vessels mean the counts are not exhaustive** — the scan says so itself, and the vault's own covert-chain work says the same.
- **DATA — price:** Brent **~$95.5, +7.6% on the week** · WTI **~$91.4, +10.4%** · **US retail diesel a RECORD ~$5.85/gal vs ~$3.76 before the war = +55.6%.**
- **✅ THE REGISTERED DISCRIMINATOR IS MET.** 9/3 9:00am filed: *"one day below average is a datum, not a trend; two or three consecutive days below average WITH the escorts running = the tail moves from 'expensive oil' toward 'supply shock'."* **Wednesday 9 and Thursday 4 are two consecutive days below the ten-day average, and the second is a 73% shortfall against it.** ⇒ **the throughput leg has moved from datum to trend. Registered as MET, with the AIS-dark caveat attached and not waved away.**
- **✅ AND THE DIESEL RECORD BREAKS THE LEVEL I FILED YESTERDAY:** 9/3 7:30am carried $5.783 as *"a war high, approaching a record (2022 peak $5.816 — recalled)."* **$5.85 clears it.** **The kill-switch's political input is now at an all-time high, six days after firing #3 spared the crack and one day after the summit asked for MORE capacity rather than lower margins.**
- **★★★★★★ AND THE SAME NUMBER IS NOW BULLISH FOR THE MARGIN AND BEARISH FOR THE VOLUME — WHICH IS EXACTLY THE TENSION FILED LAST NIGHT (analysis).** The 10:00pm entry replaced the basket's #1 disconfirmer with **demand destruction reaching US throughput**, on the IEA's own naming of **product shortages** as a demand destroyer. **A record diesel price IS that destruction operating.** ⇒ **$5.85 is simultaneously the best evidence for the crack thesis and the clearest measurement of the thing that ends it.** **The vault should stop treating record product prices as unambiguously good for the basket; they are the numerator rising and the denominator being eroded by the same move.**
- **★★★★ THE FREIGHT/AG/DISTRIBUTION CHANNEL IS THE MACRO LINK:** diesel at +55.6% is a direct cost input to freight, agriculture and distribution — **the transmission by which an energy shock becomes core-adjacent inflation, and one of the three non-monetary price sources the ISM respondents named (9/3 7:35am).** **That is what CPI on Sept 11 will be reading, and today's payroll print removed the Fed's best argument for looking through it.**
- **GRADES (16c) → [[grades]]: BASKET HOLDS — VLO 9 · MPC 9 · PBF 8 · PARR 8 · DINO 8 · PSX 7.** Crack support strengthened (flow down, diesel record); **volume risk strengthened by the same datum.** **No upgrade and no downgrade: the two moved together and the position is already stated as a bet that the crack outruns the volume loss.** **The weekly EIA throughput print is now the highest-frequency instrument on the grade** (last: 98% utilisation, runs at a 7-8 year high).
**📌 REGISTERED:** **Hormuz visible crossings as a daily series (15 → 9 → 4)** · VLCC count per week (two) · **weekly EIA US refinery throughput — the volume tell** · US distillate demand vs the record price (the destruction, measured domestically) · whether any product-export jawbone follows a record pump price (the EXIT BELL, still unrung).

### Addendum 2026-09-04 ~7:20am PDT — ⭐⭐⭐⭐⭐⭐ **THE WORLD'S LARGEST TANKER OPERATOR JUST DATED THE DISRUPTION AND NAMED ITS RE-ENTRY CONDITION — AND THE CONDITION IS THE COALITION, NOT A DECLARATION (ZH/OilPrice; Bloomberg interview)**
- **DATA: Mitsui OSK Lines CEO Jotaro Tamura — *"Given the current situation, it's difficult to see operations resuming IN ANY FORM by the end of the year."*** **Their own quarterly report last month assumed navigation *"will gradually resume from OCTOBER 2026 and be normalized in JANUARY 2027"* — that guidance is now withdrawn in an interview.** *"The situation continues to be well beyond the level of risk we can accept."* **MOL does not currently plan to return, and states the condition: it needs *"GUARANTEES AND EVIDENCE OF SUSTAINABLY SAFE PASSAGE"* before considering the route.**
- **★★★★★★ THIS IS THE EXIT-ARCHITECTURE TIMELINE, CONFIRMED FROM THE COMMERCIAL SIDE BY A PARTY WITH MONEY AT STAKE (analysis).** Last night (9/3 9:45pm) the board dated the exit: **a coalition cannot be on station before roughly year-end, therefore any "declare it over" before then is words only.** **MOL arrives at the same date from the opposite direction — and supplies the mechanism: they will not return on an announcement. They require GUARANTEES AND EVIDENCE.** ⇒ **"guarantees and evidence of sustainably safe passage" is a description of an escort-and-MCM regime. The commercial re-entry condition IS the coalition.**
- **★★★★★★ AND IT IS THE STRONGEST CONFIRMATION YET OF THE PRE-NOVEMBER FADE (9/3 9:50pm):** the vault called any pre-November declaration a fade because nothing physical can change. **The world's largest tanker operator has now said IN ADVANCE what would and would not move it — and a declaration is explicitly not on the list.** **A politician can declare the war over; the ships still do not sail until someone guarantees the water. That is not a forecast any more; it is a stated commercial policy.**
- **⇒ THE FADE NOW HAS THREE INDEPENDENT LEGS: (1) nothing physical changes before a coalition arrives; (2) returning barrels would enter a market short 2.8 mb/d of demand (IEA, 9/3 10:00pm); (3) the largest tanker operator will not move on words.**
- **ASIAN LNG CORROBORATES THE SAME BLOCKAGE: spot to ~$25.9/mmBtu, the highest since 2022, +5% on the week; QatarEnergy has EXTENDED ITS FORCE MAJEURE INTO NOVEMBER;** South Korea, India, Taiwan and Bangladesh are tendering for October-November spot. **⚠️ AND THE DEMAND-DESTRUCTION SIGNAL INSIDE IT: PAKISTAN REJECTED a BP cargo priced above $27/mmBtu as too expensive.** **That is the IEA's mechanism operating in real time in a second fuel — a sovereign buyer declining volume on price.**
- **GRADES (16c): basket HOLDS 9/9/8/8/8/7.** MOL's refusal extends the product-scarcity window past year-end (crack-supportive) while Pakistan's refusal and record diesel measure the destruction (volume-negative). **Same shape as every other datum this week: both sides strengthen, the position does not move.** **EWY 6 gains a NEGATIVE leg — Korea is tendering for record-priced spot LNG on top of its tariff exposure and Hormuz dependence.**
**📌** MOL's re-entry criteria as the coalition's commercial test · Qatar force majeure beyond November · Asian LNG spot vs the Pakistan refusal level ($27) · whether other majors follow MOL's guidance withdrawal.

### Addendum 2026-09-04 ~2:20pm PDT — **THE DIESEL RECORD IS CONFIRMED AT $5.85 (surpassing the June 2022 peak) — AND GOLDMAN PUTS GULF EXPORTS AT 15-16 mb/d, ~TWO-THIRDS OF PREWAR, WITH DARK TRANSITS OBSCURING THE COUNT (ZH scan pm).**
- **AAA: US retail diesel $5.85/gal Thursday, a record, above June 2022.** **HOCL1 (NYMEX 1-month heating-oil/crude spread): breached $100 Tuesday → $108 Wednesday → $99 Friday morning.** ⇒ **the CRACK peaked at 108 and has come off ~9 points while RETAIL made a new record — retail lags the crack, and the pump is now printing Wednesday's spread.** **Do not read the record pump price as a live crack signal; it is a lagged one, and the tradeable series is already lower.**
- **★★★★ GOLDMAN: Gulf oil exports have recovered to 15-16 mb/d, roughly TWO-THIRDS of prewar levels, "with the rise of dark tanker transits obscuring some flows from conventional tracking via AIS."** ⇒ **an independent confirmation of last night's instrument-scope finding (9/3 9:05pm): AIS-based counts UNDERSTATE flow, so the Hormuz crossing series (15 → 9 → 4) is a lower bound and its LEVEL is unreliable even where its DIRECTION is not.** **Two-thirds of prewar is materially better than the crossing counts imply, and it is the number to carry.**
- **ZH's own framing matches the board's regime: "crude itself does not keep the industrial economy humming. Diesel does."** Trump urged refiners to raise output earlier this week (the summit, filed 9/3 3:15pm).
- **GRADES (16c): basket HOLDS 9/9/8/8/8/7.** **The crack coming off 108 → 99 is the first datum this week that argues the other way, and it belongs on the record: the margin peaked Wednesday.** **Against it: retail at a record, Russian product-export restrictions, Ukrainian refinery strikes, and MOL's year-end withdrawal.** **No move — but the volume-side disconfirmer (demand destruction reaching throughput, adopted 9/3 10:00pm) is now joined by a margin-side one that is actually observable weekly.**
**📌** HOCL1 as a DAILY series (100 → 108 → 99) · Goldman's 15-16 mb/d against the AIS crossing counts · retail diesel vs the crack (the lag) · weekly EIA throughput.

### REFERENCE 2026-09-04 ~3:30pm PDT — **WHAT "BRENT" ACTUALLY IS, AND WHY THE VAULT'S DIFFERENTIAL RULE FOLLOWS FROM IT (Jake's Q: "Where does Brent come from? Is Brent regional or a type?")**
*(Benchmark mechanics — training-era knowledge, marked RECALLED throughout, ⬜ to source where it matters.)*
- **THE NAME:** the **Brent field**, discovered 1971, Shell-operated, UK North Sea east of Shetland. **Shell named its North Sea fields after BIRDS in rough alphabetical order — Auk, Brent, Cormorant, Dunlin, Eider, Fulmar — and Brent is a species of GOOSE.** A competing backronym has BRENT standing for the stratigraphic layers **Broom, Rannoch, Etive, Ness, Tarbert**; those formation names were themselves taken from the field, so **the goose is primary and the backronym is retrofitted.** ⬜
- **IT IS BOTH REGIONAL AND A TYPE — and neither any more:** as a **quality**, light and sweet, ~**38° API**, ~**0.4% sulfur** — lighter/sweeter than Gulf grades, marginally heavier/sourer than WTI (~39.6° / ~0.24%). ⬜
- **★★★★★ THE STRUCTURAL FACT: BRENT HAS BEEN REPEATEDLY RESCUED BY ADDING STREAMS, BECAUSE THE FIELD'S OWN VOLUME KEPT FALLING BELOW WHAT CAN BE RELIABLY PRICED.** **Brent alone → +Ninian → +Forties, +Oseberg (BFO) → +Ekofisk (BFOE) → +Troll (BFOET) → and since ~mid-2023, +WTI MIDLAND.** ⇒ **a US grade delivered to Rotterdam now sits inside the "Brent" basket; several streams are Norwegian; and the field the benchmark is named for is essentially finished.** ⬜ *(dates and the Midland inclusion recalled)*
- **★★★★★★ WHY THIS IS THE FOUNDATION UNDER THE 9/3 8:40pm RULE (analysis).** **Brent is a NORTH SEA basket used to price barrels that never approach the North Sea** — ESPO from the Russian Pacific, Urals from the Baltic, Dubai/Oman for the Gulf. **Every differential the vault traded this week is quoted AGAINST it.** ⇒ **a benchmark is only informative while the world is ONE market. When the physical market fragments GEOGRAPHICALLY — which is exactly what Hormuz plus Ukraine have done — the benchmark's own basis stops representing the barrels priced off it.**
- **⇒ THE $44 URALS-vs-ESPO SPREAD INSIDE ONE COUNTRY (9/4 7:20am) IS THE MEASUREMENT OF THAT FRAGMENTATION, and it is why "Brent $95" is a true statement about five North Sea streams and a Texas grade, and NOT a statement about what any Asian refiner is paying.** **The rule — "in an administered or segmented market the benchmark is the least informative price" — is not a stylistic preference; it follows from what Brent physically IS.**
- **WHY THE BOARD READS BOTH:** **Brent is the WATERBORNE, internationally traded marker** (roughly two-thirds of global crude prices off it ⬜) ⇒ the right instrument for the WAR PREMIUM and for seaborne disruption. **WTI is Cushing-delivered and landlocked in origin** ⇒ the right instrument for US domestic balances. **The Brent-WTI spread is therefore a waterborne-vs-inland measure, not a quality measure** — which is why it widens on chokepoint events and not on refinery events.
**📌** confirm the WTI Midland inclusion date and current basket composition ⬜ · Brent's share of globally priced crude ⬜ · whether any Asian benchmark (Dubai/Oman, Murban) gains share as fragmentation persists — **the natural consequence of everything above.**

## 2026-09-04 ~3:35pm PDT — ✅⭐⭐⭐⭐⭐⭐ **THE ⬜ REGISTERED FIVE MINUTES AGO PRINTS: THE GRADE STACK HAS INVERTED. MIDDLE EAST SOURS NOW TRADE $3.70-10.60 *ABOVE* BRENT (ZH/OilPrice, `raw/2026-09-04-zh-dubai-crude-toward-100.txt`)**
### THE STACK, AND IT IS UPSIDE DOWN
| Grade | Price | vs Brent |
|---|---|---|
| **Murban (UAE)** | **$106.10** | **+$10.60** |
| Dubai (futures, ~) | ~$100 | +$4.50 |
| DME Oman | $99.18 | +$3.68 |
| **Brent** | **$95.50** | — |
| WTI | $91.40 | −$4.10 |
- **★★★★★★ THE NORMAL HIERARCHY PUTS LIGHT SWEET (Brent, WTI) ABOVE MEDIUM SOUR (Dubai, Oman). TODAY THE SOURS TRADE $3.70-$10.60 ABOVE THE SWEETS.** ⇒ **QUALITY IS NOT SETTING PRICE. LOCATION AND AVAILABILITY ARE.** **Asian refineries are configured for Middle East sour and cannot substitute quickly; the barrels cannot get out of the Strait; so the grade that is hardest to obtain commands the premium irrespective of its specification.**
- **✅ AND IT ANSWERS THE ⬜ FILED AT 3:30pm — "whether Dubai/Oman or Murban gain share as fragmentation persists."** **They have not gained institutional share yet; they have done something prior to that: DECOUPLED IN PRICE.** **That is the precondition, and it is the market pricing them independently of the North Sea basket rather than off it.**
- **★★★★★★ THIS IS THE CLEANEST POSSIBLE VINDICATION OF THE 9/3 DIFFERENTIAL RULE AND OF THE BRENT-BASKET NOTE FILED MINUTES EARLIER: BRENT AT $95.50 UNDERSTATES THE WORLD'S MARGINAL CRUDE COST BY $4-11 DEPENDING ON GRADE.** **A North Sea basket — five UK/Norwegian streams plus WTI Midland — is quoting below every barrel Asia actually buys.** **"Brent $95" is now a statement about the North Sea and nothing else.**
...
### Addendum 2026-09-07 ~8:15am PDT — **JAZAN HIT AGAIN (REPORTED) — THE 9/4 ELIGIBILITY SPLIT NOW HAS A RED-SEA-SIDE CAVEAT** (detail: `war/war-board` 2026-09-07 ~8:15am)
- **DATA (reported, unattributed):** Aramco's Jazan refinery reportedly attacked Monday 9/7; damage being assessed. Second hit after 8/9 (400k bpd refining, shut to ~Aug 15).
- **THESIS (analysis):** the bypass-eligible ~49% of Hormuz volume (`:L2796`) is eligible because it can reach the Red Sea. **Jazan is on the Red Sea. A repeat strike there is the first evidence in this thread that the bypass coast is inside the target set** — the eligibility finding survives, but "eligible" no longer means "safe." Product-crack read unchanged from 8/9: refining, not crude; cracks, not flat price. Grades: refiners hold (VLO 9 / MPC 9 / PARR 8).

### Addendum 2026-09-07 ~8:30am PDT — **RETAIL: GASOLINE $4.14/gal NATIONAL AVERAGE, ~+$1 y/y, A LABOR DAY RECORD (AP/AAA); DIESEL ~$5.85 (on file since 9/4, `:L2720`).** The consumer-facing print of the crack that HOCL1 has carried above $100 since 9/1. **The CPI arithmetic, perimeters flagged:** motor-fuel relative importance in CPI ≈ 3.3-3.5% (recalled, ⬜); +$1 on a ~$3.15 base ≈ +32% y/y ⇒ **on the order of +1pp to HEADLINE y/y IF the August average tracks the holiday print (⬜ — Labor Day is a point, CPI uses the month).** Core excludes it. ⇒ **Friday's headline is largely KNOWABLE NOW from AAA; the surprise variable is core, which is Waller's gate.** Pre-registered in [[rates-board]]: breakevens should not move on a telegraphed energy component (surprise-vs-telegraphed, `ai-financing-fragility` 9/5); if they do, the inflation channel has opened. Demand side: [[demand-destruction]] — $4.14 is the price at which the 2022 volume response began (⬜ the 2022 gasoline-demand series for the base rate).

### Addendum 2026-09-07 ~8:30am PDT — **STREET-LEVEL, SECOND READING (Jake's GasBuddy screenshot, Spokane 99201, DIESEL, "Credit Only" filter; `raw/2026-09-07-gasbuddy-spokane-99201-diesel.png`): LOWEST $6.29 (4.49 mi) · CLUSTER $6.49-6.79 (City Food Mart / Conoco $6.49 · Amerimart $6.75 · Chevron $6.79, W 2nd-3rd Ave) · HIGHEST $7.29 (5.01 mi) · SPREAD $1.00 WITHIN FIVE MILES.**
- **(DATA, perimeters):** crowd-reported credit prices, 16h-2d old; AAA national $5.85 is an all-station OPIS average (cash+credit; credit typically ~$0.10 over). **Movement track, Spokane vs national:** 8/28 — Conoco truck stop sign $6.59 vs national $5.65 = **+$0.94** (`:L2314`) · 9/7 — $6.29-6.49 vs $5.85 = **+$0.44-0.64.** **Local flat-to-down ~$0.10-0.30 while the national rose +$0.20.** The premium compressed by ~$0.30-0.50; ~$0.10 of that is the cash/credit perimeter, the rest is not.
- **(THESIS, analysis):** **the West Coast is not the marginal market in this distillate shock.** PADD 5 prices off Puget Sound refining and Pacific-basin product (Singapore), not the Gulf Coast/Atlantic-basin export pull that has carried HOCL1 above $100 (`:L2720`). A high-tax, already-high region not rising while the national average sets a record says the shock is propagating through the EXPORT channel (US Gulf → Europe/LatAm diesel), which is the [[demand-destruction]] and VLO/MPC geography, not Jake's. **Two readings is a direction, not a series — n=2, two different meters (a sign, an app), ⬜ cash/credit alignment.** The $1.00 intra-city spread is the "Deal Price" dispersion that makes any single sign a weak datum; the CLUSTER ($6.49-6.79) is the number.
- **Freight math from 8/28 still stands at the cluster:** ~+$80/truck/day per $1 above the prior base; the diesel-over-regular spread is not readable from this screen (⬜ regular in 99201 for the pump-level crack).
**📌 REGISTERED:** 99201 regular · the same screen weekly (a series, not a snapshot) · PADD 5 vs PADD 3 EIA retail diesel to test the export-channel read at the official level.

## 2026-09-07 ~8:10pm PDT — ⭐⭐⭐⭐⭐⭐ **REUTERS: BUNKER FUEL IS THE THIRD PRODUCT TO GO SHORT, AND THE NUMBER REUTERS PRINTS BUT DOES NOT CONNECT IS THAT VLSFO NOW TRADES AT A ~$33/bbl PREMIUM TO BRENT — THE BOTTOM OF THE BARREL IS WORTH 34% MORE THAN THE CRUDE IT CAME FROM. TWO REGISTERED ⬜ CLOSE.** *(Jake's link; `raw/2026-09-07-reuters-ship-fuel-shortage-bunker.txt`. ⚠️ Reuters 401s from the container AND from WebFetch — retrieved via WebSearch + investing.com syndication, class 7: vary the tool. Figures are as relayed, ⬜ the Reuters original.)*
### DATA (perimeters — rule 21b)
- **VLSFO (very low sulphur fuel oil, the main shipping fuel), SINGAPORE, Sept 1: just under $825/metric ton = $130/bbl, +76% since the Iran war began. Brent over the same window: +40%.** *(Conversion check: $825 ÷ ~6.35 bbl/t = $129.9 — Reuters' own $130 reconciles.)*
- **Energy Aspects (Royston Huan): fuel oil deficit of 218,000 bpd in the THIRD QUARTER — the first shortfall it has estimated since Q3-2025, when it was a marginal 6,000 bpd.** *(Read as Q3-2026: the piece is dated 9/7/26 and names Q3-2025 as the prior instance.)*
- **SUPPLY:** **Russia fuel oil exports August = record low 591,000 bpd vs a 2025 average >860,000 bpd** (Ukrainian drone strikes on refineries). **Middle East fuel oil exports March-August −45% y/y to 447,000 bpd average. Kuwait's AL-ZOUR: ONE 26,000 bpd cargo since March vs ~191,000 bpd in January-February (−86%).**
- **INVENTORIES:** **Singapore** (world's largest bunker hub, imports >half of its ~1 mb/d demand): **stocks 30% below the three-year seasonal average**. **ARA: 30% below average**, gasoline lowest in nearly five years (Aug 27). **Fujairah: 30% below the three-year average. US EAST COAST DISTILLATE: RECORD LOW in the week to August 28.** Asia hardest hit (most reliant on Gulf flows).
- Sources named: Energy Aspects, Rystad (Valerie Panopio), Kpler, ZeroNorth.
### ✔ TWO REGISTERED OPEN ITEMS CLOSE
1. **`:L1950` 🚩🚩 "GULF PRODUCT-EXPORT VOLUMES (Ruwais / Jubail / Ras Tanura / Al-Zour), NOT HULL COUNTS."** ⇒ **Al-Zour: 191,000 → 26,000 bpd of fuel oil (one cargo since March). ME fuel oil exports −45% to 447 kb/d.** The board asked for volumes instead of hulls; here are volumes. **Al-Zour sits INSIDE Hormuz (`:L1916`) — this is the Hormuz PRODUCT-export leg, measured.**
2. **`:L2666` "East Coast distillate vs heating season (Oct 1)."** ⇒ **PADD 1 distillate at a RECORD LOW, week to Aug 28 — twenty-three days before the heating season opens.**
### THESIS (interpretation — NOT fact)
- **★★★★★★ THE WHOLE BARREL IS NOW ABOVE CRUDE, AND THAT IS THE CONVERSION-CAPACITY THESIS IN ITS PUREST FORM (analysis).** VLSFO at **$130/bbl against Brent ~$97 = a ~$33/bbl PREMIUM, +34%.** Residual fuel normally trades at a **discount** to crude — it is what is left after the valuable cuts are taken. **When the bottom of the barrel is worth a third more than the barrel, the scarce good is not oil; it is the ability to turn oil into anything.** The vault has argued the wedge from crude-above-normal / products-below-normal inventories (9/3 8:50am: crude ~1% above the 5-yr average, gasoline −6%, distillate −14%, utilisation 98%). **This is the same statement in prices, at the one product that had never joined.**
- **★★★★★ AND IT CONFIRMS THE CRACK THESIS'S MECHANISM FROM THE BYPRODUCT SIDE — THE STRONGEST FORM OF THE SUPPLY LEG YET.** Reuters' causal claim is that refiners are **maximising diesel and other products AT FUEL OIL'S EXPENSE.** ⇒ **the global system is already running at maximum distillate yield — and US East Coast distillate is STILL at a record low.** **Maximum yield plus record-low stocks means the distillate shortage is structural, not an inventory game.** That is a harder test than any crack print: the system has already pulled its only lever.
- **★★★★★ THE REFLEXIVE FREIGHT LOOP, NEW TO THIS BOARD:** bunker fuel is the **cost input of shipping itself**. The war lengthens voyages (Saudi Cape routings and ~1.9 mb/d via SUMED, `war-board` 11:25am) ⇒ **more bunker burned per delivered cargo** ⇒ tighter bunker ⇒ higher VLSFO ⇒ higher freight ⇒ higher delivered cost of the same energy. **Three cost layers now stack on one cargo: war-risk insurance ($7-8/bbl of Brent, 9/7 11:25am) + freight (BDI 3,331, a Dec-2023 high) + bunker (+76%).** ⇒ **the LANDED price of energy is rising faster than any benchmark shows, which is the mechanism behind Europe's diesel pull ([[europe-energy-crunch]] 9/7) and behind why $/bbl understates the shock.**
- **THE ASIAN BIND, and it touches the live disconfirmer:** Singapore imports over half its bunker demand into a market where Gulf supply is −45% and Russian supply is at a record low. **A Chinese product-export resumption — the crack basket's #1 disconfirmer (`demand-destruction` 9/7 5:35pm) — would land HERE first, as fuel oil into Singapore.** ⇒ **the disconfirmer and this shortage are the same variable seen from two ends; watch Chinese fuel-oil exports specifically, not just diesel.**
- **⚠️ WHAT THIS DOES *NOT* SAY:** it does not say refining margins are broadly higher — it says the **product mix** is being forced. ~~And a resid premium **reduces** the marginal value of a coker (upgrading resid you could sell at $130 is a worse trade than it was), which cuts against the highest-complexity configurations at the margin.~~ **VLO/MPC minimise fuel oil by design: they are not selling into this shortage — their gain is the distillate crack this piece confirms.** ⬜ **PARR's fuel-oil yield (Hawaii/Wyoming configuration) — the one grade where a resid premium could be a direct positive, and the vault does not hold the number.**
  ⟲ SUPERSEDED 2026-09-08 → oil-value-chain.md:L2882 — Had the refiner on the wrong side: complex refiners are net BUYERS of resid as secondary-unit feedstock, so a resid premium raises the coker's value and the bidding is itself a cause of the shortage
### GRADES (16c) → [[grades]]
**No moves. VLO 9 · MPC 9 · PSX 7 · PARR 8 hold** — this is confirmation of the mechanism already priced into a 9, arriving as a byproduct datum rather than a margin datum (16c: no re-grading on the readout of a priced driver). Shipping/bunker names: **NR, no view.**
**📌 REGISTERED:** **HSFO-VLSFO spread (scrubber economics) — ⬜, the piece does not give it** · **Chinese fuel-OIL export volumes to Singapore (the disconfirmer's landing point)** · PARR fuel-oil yield · Singapore/ARA/Fujairah stocks weekly vs the −30% · PADD 1 distillate through Oct 1 · Energy Aspects Q4 balance.
**Links:** [[demand-destruction]] · [[war/war-board]] (Al-Zour inside Hormuz; freight/insurance) · [[europe-energy-crunch]] · [[forest]]

### ⛔ CORRECTION 2026-09-07 ~8:15pm PDT — **THE FULL REUTERS TEXT (Jake's paste, `raw/2026-09-07-reuters-ship-fuel-shortage-bunker-FULL.txt`) BREAKS MY OWN COKER LINE FROM FIVE MINUTES EARLIER, AND ADDS A CHINA CONTRADICTION THAT LANDS ON THE BASKET'S #1 DISCONFIRMER**
  ⟲ SUPERSEDES oil-value-chain.md:L2876 — Had the refiner on the wrong side: complex refiners are net BUYERS of resid as secondary-unit feedstock, so a resid premium raises the coker's value and the bidding is itself a cause of the shortage
### ⛔ THE CORRECTION — I HAD THE REFINER ON THE WRONG SIDE OF THE TRADE
- **I wrote (`:L2876`, now struck):** *"a resid premium REDUCES the marginal value of a coker — upgrading resid you could sell at $130 is a worse trade than it was."* **That assumed the refiner OWNS the resid and chooses whether to sell it or crack it.**
- **Energy Aspects' Royston Huan, in the text I did not have:** *"Record-low gasoline and diesel inventories will incentivise refiners globally to MAXIMISE SECONDARY UNIT RUNS WITH MORE FUEL OIL FEEDSTOCK BARRELS, in turn tightening fuel oil balances."* Reuters: **"Dangote and other refineries can use fuel oil as FEEDSTOCK in secondary refining units to make other fuels."**
- ⇒ **THE REFINER IS A NET BUYER OF RESID, NOT A SELLER OF IT.** Complex refiners are **bidding for fuel oil as feedstock** because the products are worth more still. **So the coker is MORE valuable, not less — and that bidding is itself a cause of the fuel-oil shortage.** ⇒ **fuel oil is short on DEMAND as well as supply, which is the opposite of the pure-byproduct story I filed.** **Error class: I reasoned about the position without establishing which side of it the party sits on — the same shape as the bypass residual (two measures of one quantity) and the ESPO ratio.** *(⚠️ Two fuel oils, kept apart: VLSFO is the finished 0.5%S marine fuel at $130/bbl; the feedstock barrels are HSFO/straight-run resid. Both tightening, and the link is that secondary-unit bidding removes the blendstock.)*
- **✅ AND IT STRENGTHENS THE CRACK READ RATHER THAN WEAKENING IT: complexity is being paid twice** — once on the distillate crack, once on the ability to buy a discounted-to-product feedstock and upgrade it. **VLO/MPC/PSX (high-complexity, coking) are on the right side of BOTH.** Grades unchanged at 9/9/7 — this raises confidence in the existing number, it does not add a new driver (16c).
### ⛔ THE CHINA CONTRADICTION — TWO SOURCES, ONE WEEK, OPPOSITE DIRECTIONS, ON THE VAULT'S #1 DISCONFIRMER
- **Reuters (today):** *"CHINA HAS ALSO CUT REFINING CAPACITY AND EXPORTS to avoid burning stocks."*
- **Bloomberg via ZH (tonight, 5:35pm entry), GL Consulting's Liao Na:** *"THE RESUMPTION OF FUEL EXPORTS"* is one of the reasons Chinese refiners are buying crude.
- ⇒ **These are reconcilable as level vs change (Reuters describes the state through 2026; Liao describes a turn at the margin) — but they are not reconcilable from the outside without the quota number.** **The crack basket's single largest threat now has two wire sources pointing opposite ways in the same week.** ⇒ **🔴🔴 THE CHINESE PRODUCT-EXPORT QUOTA IS PROMOTED TO THE MOST VALUABLE UNFETCHED NUMBER IN THE BOOK** (was "top of the oil lane," 5:35pm). **Fetch route: MOFCOM quota announcements / Kpler product-export volumes by grade — and per the bunker piece, watch FUEL OIL specifically, since Singapore is where a Chinese resumption lands first.**
### NEW MATERIAL IN THE FULL TEXT (beyond the 8:10pm entry)
- **US DIESEL PRICES HIT RECORD HIGHS ON FRIDAY (9/4)** — attributed to renewed US-Iran hostilities + Ukrainian strikes on Russian refineries. *(The board holds retail $5.85 on 9/4; this is the same day from the wholesale/wire side.)*
- **NIGERIA'S DANGOTE (650,000 bpd) named:** diesel/gasoline/jet exports UP, fuel oil exports DOWN (Kpler). **The Atlantic basin's newest large refinery is executing the same yield shift — and it supplies Europe/West Africa, which is the [[europe-energy-crunch]] 9/7 pull.**
- **✅ MY FREIGHT LOOP IS SOURCED, NOT INFERRED:** Panopio — *"ships sailing longer routes to avoid Bab el-Mandeb or the Red Sea altogether due to Houthi threats ALSO INCREASE DEMAND."* ⇒ **the war manufactures its own incremental fuel demand through voyage length.** Filed at 8:10pm as analysis; it is now a named analyst's claim.
- **Reuters states the wedge outright:** *"While crude oil has avoided major price spikes in recent months, refined product prices have soared."* **Fuel oil "joins gasoline, diesel and jet fuel" — the shortage is now named across FOUR products, and crude is not one of them.**
- **"Ships and POWER PLANTS"** — the Q3 deficit lands in the quarter of peak Gulf power burn. ⬜ Saudi/Egypt summer fuel-oil burn volumes.
**📌 REGISTERED (updated):** **🔴🔴 China product-export quota + Chinese FUEL OIL exports to Singapore** · HSFO-VLSFO spread (⬜, still not given) · Dangote monthly product exports by grade · Saudi/Egypt power-burn fuel oil · PARR fuel-oil yield.

## 2026-09-09 ~7:20am PDT — ⭐⭐⭐⭐⭐⭐ **DECOMPOSE THE PUMP BEFORE READING IT (RULE 20), AND THE RECORD IS NOT THE STORY — THE *RATIO* IS. DIESEL $5.94 AGAINST GASOLINE $4.22 IS A RATIO OF **1.41**, AND STRIPPING OUT THE SHARED CRUDE INPUT LEAVES ROUGHLY **$1.30/GAL — ~$55/BBL — OF PURELY DISTILLATE-SPECIFIC PREMIUM.** THAT IS THE BOARD'S THESIS EXPRESSED IN THE ONE NUMBER THAT CANNOT BE EXPLAINED BY $100 BRENT.** *(US-open brief, `raw/2026-09-09-market-intelligence-us-open.txt`)*
### DATA
- **US retail diesel ~$5.94/gal · US retail gasoline ~$4.22/gal · Brent broke $100 · WTI ~$95.**
- ✓ **Rule 21 — the board's own diesel series:** $5.445 (8/18, `:L1610`) → $5.652 (8/24, `:L2256`) → **record $5.85 (9/4, `:L2700`)** → **$5.94 today.** **vs ~$3.76 pre-war = +58.0%.** **+9¢ since the 9/4 record.**
- **⚠️ THE CAVEAT THE BOARD WROTE ON 9/4 AND MUST APPLY TO ITSELF TODAY (`:L2720`): retail LAGS the crack.** On 9/4 the HOCL1 heating-oil/crude spread had already rolled 108 → 99 **while retail was making a new record.** ⇒ **⛔ a new pump record is NOT evidence of a live crack. ⬜ HOCL1 TODAY is required before this print is read as anything but a lag.** 🚩 **The single cheapest check on this entry, and the board has been burned by skipping it once already.**
### THESIS (interpretation — NOT fact)
- **★★★★★★ THE RATIO IS THE ARGUMENT, AND IT IS THE ONLY VERSION OF THIS DATUM THAT SURVIVES A $100 BRENT.** Diesel and gasoline share the same crude input; **if the pump is high because crude is high, BOTH rise and the ratio is unchanged.** **The ratio is 1.408.** ⇒ **at a ~1.10 ratio, $4.22 gasoline implies ~$4.64 diesel. Actual is $5.94.** ⇒ **~$1.30/gal ≈ $55/bbl of premium that is DISTILLATE-SPECIFIC and cannot be attributed to crude at all.** **⇒ THE WAR PREMIUM IS NOT IN CRUDE. IT IS IN THE MIDDLE OF THE BARREL, AND IT IS BIGGER THAN THE ENTIRE MOVE IN CRUDE.** *(Analysis. ⚠️ ⬜ **the historical US retail diesel/gasoline ratio range** — I used 1.10 as a working normal from the general shape of recent years and did NOT source it. The DIRECTION is unambiguous; the exact $1.30 depends on that anchor and is stated as an estimate, not a measurement. 🚩 EIA's weekly retail series gives both and would make this exact in one pull.)*
- **✓ AND IT CONFIRMS, THIRD INDEPENDENT WAY, WHAT REUTERS STATED OUTRIGHT AT `:L2898`: *"While crude oil has avoided major price spikes in recent months, refined product prices have soared."*** **The board now has (1) the crack basket, (2) the bunker/VLSFO $33/bbl-over-Brent print, and (3) the retail ratio — three different instruments at three different points in the chain all saying the shortage is in PRODUCTS, not crude.** **Rule 9 satisfied properly: three instruments, not three outlets.**
- **★★★★★ THE PAPER-vs-PHYSICAL GAP THE BOARD IDENTIFIED HAS NOW CLOSED — AND IT CLOSED THE WRONG WAY. On ~9/7 (`:L2754`) the board filed: *"Brent and WTI DIPPED on a perceived PAUSE in strikes, while Middle East physical grades RALLIED toward and through $100… the futures benchmarks priced a political interpretation; the physical grades priced availability."*** **Brent has now crossed $100 itself.** ⇒ **the convergence happened by PAPER RISING TO PHYSICAL, not by physical falling back to paper.** ⇒ **the physical market was right and the futures market was pricing a political story that did not hold.** **✔ THAT IS A SCORED CALL: the board explicitly said to trust the physical grades over the benchmark, and the benchmark came to them within 48 hours.** *(And the discipline it earns: when paper and physical diverge in a supply event, weight the physical. Adopted.)*
- **⚠️ WHAT THIS DOES *NOT* SAY, AND THE BRIEF OVERSTATES IT SLIGHTLY: "diesel is arguably more important than crude now" is right about TRANSMISSION and wrong if read as a trade.** **The distillate premium is where the economic damage transmits — freight, food, industrial cost — but it is also the leg with the largest normalisation risk, because a refinery yield shift can add distillate supply in weeks while a lost tanker cannot be replaced in weeks.** ⇒ **the crack is the more VIOLENT and less DURABLE of the two exposures.** **This is why the board's coker correction (9/8) matters: refiners are net BUYERS of resid as secondary-unit feedstock and are already maximising secondary runs (`:L2887`, Energy Aspects) — the supply response is ALREADY UNDERWAY, which caps the crack even as retail keeps printing records.**
- **★★★★ THE CONSUMER ARITHMETIC, BECAUSE IT IS WHERE THIS MEETS JAKE'S EXPECTATIONS-WEDGE THREAD: diesel +58% from pre-war is a COST-PUSH shock landing on freight, food and industrials — i.e. on the basket of the NON-asset-owning household, which is exactly the cohort the UMich decomposition showed at the high end of inflation expectations while stockholders stayed calm.** ⇒ **the expectations wedge Jake flagged has a physical cause sitting at $5.94 a gallon, and it is not in the core measures the calm cohort watches.** **⬜ CPI by income quintile (standing) is the test, and Friday's CPI is the date.** → [[new-economy-regime]], [[demand-destruction]].
### GRADES (16c) → [[grades]]
**XOM/CVX/refiners: no moves today — the board's refining names already carry the crack read and a +9¢ retail print is a lagged confirmation, not a driver.** ⚠️ **The honest caution repeats: the crack has been rolling (108→99 on 9/4) while retail makes records. A refiner grade set on the retail print is set on the wrong series.**
**📌 REGISTERED:** 🚩 **HOCL1 TODAY vs 99 — is the crack re-accelerating or is retail still catching up?** · 🚩 **EIA weekly retail diesel AND gasoline (exact ratio, and its historical range — makes the $1.30 estimate a measurement)** · 🔴 **12:00 ET EIA September STEO — the standing ⬜ from `demand-destruction:L4229`, and its prior vintage assumed ME normalisation with Q3 Brent ~$85 against $100+ spot** · Chinese product-export quota (standing 🔴🔴).
**Links:** [[demand-destruction]] · [[europe-energy-crunch]] · [[war/war-board]] · [[rates-board]] · [[new-economy-regime]]
- **Addendum 2026-09-09 ~9:40am PDT (Daily Brief) — ✔ **THE 7:20AM READ IS CONFIRMED INDEPENDENTLY AND IN THE BRIEF'S OWN WORDS: "Brent futures have finally CAUGHT UP with physical crude and refined products that were already trading above the psychological $100 threshold."*** **Brent ~$100.80-100.95, WTI ~$95.60.** ⇒ **the board filed this at 7:20am off its own 9/7 entry (`:L2754`) — paper rose to physical, physical was right — and the brief reaches it separately three hours later. Convergence, not corroboration: same conclusion, independent path.** **US national diesel above $5.94/gal confirmed as a fresh record; the 1.41 diesel/gasoline ratio decomposition filed this morning stands and is untouched by the new print.**
- **⭐ AND THE BRIEF ADDS THE TIMING POINT THE BOARD HAD NOT STATED PLAINLY, WHICH MATTERS FOR FRIDAY: **AUGUST CPI LARGELY *PREDATES* THIS OIL SURGE.*** ⇒ **⛔ A BENIGN FRIDAY CPI WOULD NOT BE EVIDENCE AGAINST THE ENERGY PASS-THROUGH — IT WOULD BE EVIDENCE THAT THE PASS-THROUGH HAS NOT ARRIVED YET.** **The relevant prints for $100 Brent and $5.94 diesel are SEPTEMBER CPI (October) and, sooner, Friday's PRELIMINARY UMICH INFLATION EXPECTATIONS at 10:00am, which are current-week and pump-price-sensitive.** ⇒ **📌 THE ORDERING FOR FRIDAY: UMich expectations are the LIVE energy read; August CPI is a HISTORICAL one. The board should weight the 10:00am release above the 8:30am one for this specific question, which inverts the normal hierarchy.** **✓ And it connects to the standing wedge: UMich splits expectations by stockholding, which is where Jake's asset-owner observation is measured.** 🚩 **PRE-REGISTERED before both prints.**
- **Addendum 2026-09-10 ~9:10am PDT — ⛔ **TWO SOURCES, NINETY MINUTES APART, DISAGREE ON BRENT BY $4 AND THE BOARD SHOULD NOT AVERAGE THEM.** The US-open brief (7:08am) said **"Brent >$105 and WTI ~$100."** The holdings scan (8:27am), citing **Reuters**, says the **Sept-9 settlement was $101.21 (+3.4%)** and **Thursday early trade was ~$101.34.*** ⇒ **⚠️ A $4 GAP ON THE SAME MORNING. Both cannot be right, and the board has been quoting ">$105" in three entries filed since 7:20am.**
- **📌 THE SCAN'S FIGURE IS THE BETTER-SOURCED ONE — a named settlement price attributed to Reuters, versus an unattributed level in a fast brief — and it is ADOPTED PENDING A THIRD MARK.** ⇒ **the entries filed at 7:20, 7:40 and 8:20 that reference ">$105" should be read as "~$101" until a third source settles it.** **⚠️ THE DIRECTION OF EVERY CONCLUSION IN THOSE ENTRIES IS UNAFFECTED — the Hormuz-at-11%/inventory-buffer synthesis, the Yamal front and the diesel pass-through all hold at $101 exactly as at $105 — but the LEVEL was wrong in three places and a level that appears three times starts to look verified.** **✔ SAME ERROR CLASS AS THE CPI 4.2% CATCH THIS MORNING: a figure repeated is not a figure confirmed.**
- 🚩 **⬜ A THIRD BRENT MARK. This is the cheapest possible check and the board has been building on an unverified level for two hours.**

## 2026-09-10 ~7:15pm PDT — ⛔⭐⭐⭐⭐⭐⭐⭐ **APPEC (Vitol + KPC) SAYS THE DIESEL CRUNCH WORSENS — AND IT IS *LITERALLY* THIS MORNING'S "N COMPANIES, ONE STAGE" RULE. ⛔ BUT THE PIECE DROPS A NUMBER IN PASSING THAT **CONTRADICTS THE VAULT'S HORMUZ FLOW FIGURE BY 5×** — AND THAT SAME NUMBER **RESOLVES A PUZZLE THIS BOARD HAS BEEN CARRYING FOR WEEKS.*** *(OilPrice via ZH, 2pp, full text → `raw/2026-09-10-zh-diesel-crunch-refining-capacity.pdf` + `.txt`)*

### ⛔ CLASS 8 FIRST — AND I ADOPTED THE EXACT RULE THIS MORNING, TEN HOURS AGO
- **The speakers: **RUSSELL HARDY, CEO of VITOL — the world's biggest independent oil trader** — and **KPC's international marketing MD**, both at **APPEC**, the industry's own conference, in the same week.**
- ⇒ **⛔ THIS IS THE 9/10 CONFERENCE-ARTIFACT CATCH FIRING IN ENERGY: *"'N outlets, one origin' has a twin in 'N COMPANIES, ONE STAGE.'"* **A room of oil traders and refiners telling you product stays tight is the most interested testimony available.***
- ⇒ **✔ BUT HERE IS THE BETTER APPLICATION OF MY OWN RULE, AND IT MATTERS: **THE DISCOUNT IS FOR CONFERENCE TALK THAT LACKS AN INDEPENDENT INSTRUMENT. THIS ONE HAS FOUR, ALL GOVERNMENT:** EIA retail diesel **$5.967 = an all-time high in 1,695 weeks** · the diesel/gasoline ratio at the **99.4th percentile** · BLS PPI diesel **+24.1% m/m** · EIA distillate inventories **below the entire five-year range.**
- ⇒ **★★★ THIS MORNING'S FINDING WAS *"BULLISH = MANAGEMENT AT CONFERENCES, BEARISH = GOVERNMENT STATISTICS."* **HERE THEY AGREE — AND THAT IS THE RARE CASE.** ⇒ **📌 THE RULE REFINES: do not discount conference talk mechanically — CHECK WHETHER AN INDEPENDENT INSTRUMENT CONCURS. When it does, the conference is CORROBORATION rather than an artifact.**

### ⛔⛔ THE 5× DISCREPANCY — AND IT IS THE MOST IMPORTANT LINE IN THE PIECE
...
| | flow | perimeter |
|---|---|---|
| **VAULT (Rystad-corroborated)** | **~2.0 mb/d** | *"Hormuz runs at ~11%… **2.0/17.5 = 11.4%**"* — total outbound |
| **THIS PIECE** | **~10 mb/d** | "outbound flows," crude + products |
- ⇒ **⛔ SAME APPARENT PERIMETER, **FIVE TIMES APART.** Rule 21(b): no arithmetic happens until this resolves. **I am not quoting either as settled.**
- ⇒ **⭐⭐⭐ BUT THE ARTICLE IS ASSERTING A RECOVERY, TWICE AND EXPLICITLY — *"the UPTICK in flows"* and *"higher crude oil flows out of the Persian Gulf in recent weeks"* — AND 10 mb/d RESOLVES A PUZZLE THIS BOARD HAS BEEN CARRYING: `oil-value-chain` holds *"**AND THE PRICE IS THE PUZZLE.** Hormuz contested + CPC halted AGAIN + Russian refineries burning…"* — the board has repeatedly asked why Brent is not higher.** ⇒ **⇒ IF OUTBOUND IS 10 mb/d RATHER THAN 2, THE PRICE STOPS BEING A PUZZLE.** **A standing anomaly is evidence FOR the number that dissolves it.** 🚩🚩 **⬜ HORMUZ OUTBOUND, PRIMARY-SOURCED — this is now the highest-value unfetched number on the oil boards, above the Brent mark.**

### ⭐⭐⭐ AND THE RATIO IS THE FINDING EVEN IF THE LEVEL IS WRONG — **1 IN 10**
- **Only **1 of every 10 barrels** leaving the Gulf is a refined product. **THE GULF EXPORTS CRUDE, NOT DIESEL.***
- ⇒ **★★★★★★★ **THEREFORE EVEN A *FULL* HORMUZ NORMALISATION DOES NOT FIX THE DIESEL SHORTAGE** — the strait was never carrying much distillate. Reopening it relieves CRUDE and leaves PRODUCTS where they are.** *(Analysis. The ratio is scale-invariant, so it survives the 2-vs-10 dispute intact.)*
- ⇒ **⇒ **THE BOTTLENECK HAS MOVED FROM TRANSIT TO CONVERSION.** This is no longer a crude-supply story; it is a REFINING-CAPACITY story, and the piece names all four constraints: Iranian strikes on Middle East refineries · near-daily Ukrainian drone strikes on Russian refineries · **Russia's diesel export ban, "until at least the end of September"** · US refineries at maximum utilisation **on deferred maintenance.** 📌 **REGIME CHANGE RECORDED.**

### ⇒ IT PARTIALLY DEFUSES MY OWN CALL FROM 40 MINUTES AGO — AND VALIDATES THE GRADING ORDER
- **At 6:35pm I named **POLITICAL REVERSAL** the energy book's dominant risk, on the grounds that political constraints reverse in months.**
- ⇒ **⛔ THAT IS TRUE OF THE **CRUDE** LEG AND MUCH LESS TRUE OF THE **DISTILLATE** LEG. **A CEASEFIRE REOPENS A STRAIT. IT DOES NOT REBUILD A STRUCK REFINERY, LIFT RUSSIA'S EXPORT BAN, OR UN-DEFER US MAINTENANCE.*** ⇒ **⇒ THE DISTILLATE LEG IS MATERIALLY MORE DURABLE AGAINST POLITICAL REVERSAL THAN THE CRUDE LEG.**
- ⇒ **✔ AND THAT **INDEPENDENTLY VALIDATES THE GRADING ORDER I SET 20 MINUTES AGO** — distillate crack above crude; XOM/CVX 6 above COP/OXY 5 — **for a mechanism I did not have when I set it.** **⚠️ and if the 10 mb/d figure is right, the crude leg is weaker still, which would push COP/OXY DOWN rather than up. NOT MOVED on an unresolved discrepancy.**

### ⭐⭐ THE FIRST GOOD *NAMED, DATED* RISK TO THE REFINERY BASKET — AND IT IS NOT DEMAND
- **US refineries *"have been running at MAXIMUM capacity this summer, having **DELAYED MAINTENANCE**… unlikely to continue operating at these elevated utilization rates for much longer."* KPC: sustaining these rates to year-end *"is going to be an achievement."***
- ⇒ **⭐ THE BASKET'S REGISTERED #1 DISCONFIRMER IS *"DEMAND DESTRUCTION REACHING US THROUGHPUT."* **THIS IS A SUPPLY-SIDE RISK TO THE SAME LINE, AND IT IS MECHANICAL RATHER THAN ECONOMIC: DEFERRED TURNAROUNDS MUST BE CAUGHT UP, AND TURNAROUND SEASON IS Q4.*** ⇒ **⛔ AND IT CUTS BOTH WAYS — less throughput TIGHTENS product (crack UP) while the individual refiner processes fewer barrels (VOLUME DOWN). **MARGIN UP, VOLUME DOWN, on names already carried at 9.*** 📌 **ADDED as a second disconfirmer to the basket, distinct from demand.**
- **"A very difficult winter coming in Northwest Europe… this is only the beginning"** ⇒ ✔ **converges with tonight's EU storage work from an entirely separate direction (product vs gas).**

### GRADES (16c) → [[grades]] — **NO MOVES, AND THE REASONING CHANGES**
- **Refiners HOLD 9/9/8/8/8/7. **The FUNDAMENTAL strengthens (durability against political reversal) AND a NEW risk appears (deferred maintenance, Q4, volume).** Net unchanged at a 99.4th-percentile crack — right thesis, extended expression, now with two named disconfirmers instead of one.**
- **COP 5 / OXY 5 HOLD — ⚠️ but flagged: if Hormuz outbound is really 10 mb/d, the crude thesis is weaker than the vault assumes and these are too HIGH, not too low. Awaiting the primary.**
**📌 REGISTERED:** 🚩🚩 **⬜ HORMUZ OUTBOUND PRIMARY — now the #1 unfetched number on the oil boards (2 vs 10 mb/d, 5×)** · ★ **1-in-10 ratio: a full Hormuz reopening does NOT fix diesel — the bottleneck moved from TRANSIT to CONVERSION** · 📌 **distillate is more durable against political reversal than crude — validates tonight's grading order** · ⭐ **NEW basket disconfirmer: deferred US maintenance, Q4, margin-up/volume-down** · 🚩 **⬜ Russia's diesel export ban past end-September** · 📌 **RULE REFINED: check whether an independent instrument concurs before discounting conference talk.**

## 2026-09-10 ~7:30pm PDT — ⛔⛔⭐⭐⭐⭐⭐⭐⭐ **JAKE, TWICE IN FIVE MINUTES: *"RUSSIA'S DECREE IS CAUSED BY REFINERY CONSTRAINT TOO… THEY WERE IMPORTING AT ONE POINT"* AND *"CHINA IS POLITICAL BUT IMPORTS MOST ENERGY ANYHOW."* **BOTH CORRECT. THE FIRST BREAKS MY 7:25pm TAXONOMY AGAIN — I SORTED BY *FORM* INSTEAD OF *CAUSE* — AND CHASING THE SECOND SURFACED THE RELIEF VALVE THE APPEC PIECE CONSPICUOUSLY DID NOT MENTION.*** ⟲ **CORRECTS the 7:25pm table (`power-not-petroleum`).**

### ⛔ CORRECTION 1 — A DECREE CAUSED BY DAMAGE INHERITS THE DAMAGE'S CLOCK
- **I put **Russia's diesel export ban** in the PERMISSION column as *"reverses by a decision, days-to-months."* **JAKE: the ban EXISTS BECAUSE refined capacity is consumed domestically — Russia was at one point IMPORTING product.***
- ⇒ **⛔ **A NET DIESEL EXPORTER IMPORTING REFINED PRODUCT IS DEFINITIVE EVIDENCE THAT THE BINDING CONSTRAINT IS PHYSICAL, NOT POLICY.** Lifting the ban without repairing the refineries simply exports a domestic shortage. **THE DECREE IS THE *SYMPTOM*; THE BURNING REFINERIES ARE THE *DISEASE*.***
- ⇒ **★★★★★★ **THE RULE, AND IT IS HIS: CLASSIFY A CONSTRAINT BY *WHAT WOULD HAVE TO CHANGE FOR IT TO LIFT*, NOT BY THE INSTRUMENT THAT EXPRESSES IT.** I sorted by FORM (decree vs damage). The correct sort is by CAUSE.** ⇒ **Russia's export ban MOVES to the PHYSICAL column.**

### ⛔⛔ AND IT GENERALISES — MOST OF MY "PERMISSION" COLUMN HAS A PHYSICAL SUBSTRATE
| I filed as PERMISSION | the physical substrate underneath | verdict |
|---|---|---|
| **Russia's export ban** | **refineries burning; was importing product** | ⇒ **PHYSICAL** |
| **Venezuela sanctions** | **production capacity degraded by years of underinvestment** — lifting sanctions does not instantly produce barrels | ⇒ **MOSTLY PHYSICAL** |
| **US coal policy** | **retired plants are DEMOLISHED, not mothballed** — and the board's own standing ⬜ is the **EIA-860M RETIREMENT SCHEDULE**, precisely because retired capacity does not return by decree | ⇒ **PARTLY PHYSICAL** |
| Hormuz transit | Iran's choice — but ~10 tankers and Saudi VLCCs physically destroyed | mostly permission, physical tail |
| Bab-el-Mandeb | Houthi decision + territory held | permission |
| EU storage mandate | none | **genuinely permission** |
- ⇒ **⛔⛔ **MY 6:30pm CALL — *"THE ENERGY BOOK'S DOMINANT RISK IS POLITICAL REVERSAL"* — IS NOW WRONG IN MOST OF ITS OWN INSTANCES, NOT JUST ONE.** Two rounds of correction from Jake have moved the majority of the list across the line.** ⇒ **✔ AND IT STRENGTHENS THE 7:25pm CONCLUSION RATHER THAN WEAKENING IT: a bigger PHYSICAL column and a smaller PERMISSION column makes **"A CEASEFIRE WIDENS THE CRACK"** MORE true, not less.**

### ⭐⭐⭐⭐ CORRECTION 2 — AND CHASING IT FOUND WHAT VITOL AND KPC LEFT OUT
- **He is right that China's constraint is import-dependence rather than policy. But the vault holds something sharper, filed 9/3 — **Energy Aspects' Liao Na: *"THE RESUMPTION OF FUEL EXPORTS is one of the reasons Chinese refiners are buying crude."*** And separately: **Chinese refiners paying RECORD ESPO premiums, >$7/bbl over Brent, offers to $10.**
- ⇒ **★★★★★★★ **CHINA IS NOT MERELY AN IMPORT-DEPENDENT CONSUMER. IT IS THE WORLD'S SWING REFINER — IT IMPORTS CRUDE, REFINES IT, AND EXPORTS PRODUCT — AND ITS REFINING CAPACITY IS **UNDAMAGED.*** ⇒ **⇒ CHINESE EXPORT QUOTAS ARE THE ONE LARGE, INTACT, POLICY-CONTROLLED SOURCE OF REFINED PRODUCT LEFT ON EARTH.** ⇒ **that is the DIESEL CRUNCH'S RELIEF VALVE, it IS political exactly as Jake said, and it cuts the OPPOSITE way from what "political" meant in my framing.**
- ⇒ **⛔ AND NOW RE-READ THE APPEC PIECE: Vitol and KPC named **FOUR** constraints — Middle East refineries, Russian refineries, Russia's ban, US deferred maintenance. **THEY DID NOT MENTION CHINA'S SPARE REFINING CAPACITY OR ITS EXPORT QUOTAS.*** ⇒ **⇒ CLASS 8 WITH A SPECIFIC OMISSION ATTACHED: **A TRADER LONG PRODUCT DOES NOT LEAD WITH "CHINA COULD FLOOD THIS MARKET."** I applied the conference discount generically at 7:15pm; **the actual tell was the MISSING VARIABLE, and I only found it because Jake pushed on China.***
- ⇒ **⭐⭐ AND THE DEMAND SIDE INVERTS MY "DEMAND DESTRUCTION" FRAMING AT THE MARGIN: **PAKISTAN RATIONS** (rejects a $26.97 cargo, takes 24-hour blackouts). **CHINA PAYS** (record ESPO premiums). **EUROPE PAYS** (+20.5% over the international mark).** ⇒ **the marginal molecule goes to whoever can pay, and the two largest buyers both can. ⇒ demand is MORE inelastic than the demand-destruction file implies, because the price-takers are small and the price-payers are large.**

### GRADES (16c) → [[grades]] — **NO MOVES; A THIRD DISCONFIRMER, AND IT IS THE BEST ONE**
- **Refinery basket disconfirmers now number THREE, and they have different clocks: (1) demand destruction reaching US throughput *(registered 9/3)* · (2) deferred US maintenance, Q4, margin-up/volume-down *(added 7:15pm)* · (3) ⭐ **CHINESE PRODUCT-EXPORT QUOTA RELEASE — the only one that can add SUPPLY at scale from UNDAMAGED capacity, on a POLICY timescale.***
- ⇒ **📌 (3) IS THE SHARPEST DISCONFIRMER THIS BASKET HAS EVER HAD, and it is the one the industry's own conference omitted.** 🚩🚩 **⬜ CHINA'S CURRENT REFINED-PRODUCT EXPORT QUOTA AND ITS UTILISATION — now the #2 unfetched number on the oil boards, behind only Hormuz outbound.**
**📌 REGISTERED:** ★★ **RULE (Jake's): classify a constraint by WHAT MUST CHANGE FOR IT TO LIFT, not by the instrument expressing it** · ⛔ **Russia's export ban → PHYSICAL column; Venezuela and US coal have physical substrates too** · ⛔ **the 6:30pm "political reversal is dominant" call is wrong in MOST of its instances now** · ✔ **which makes "a ceasefire widens the crack" MORE true** · ★★★ **CHINA IS THE SWING REFINER with UNDAMAGED capacity — the relief valve APPEC omitted** · 🚩🚩 **⬜ Chinese product-export quota = #2 unfetched number** · 📌 **demand is more inelastic than filed: the price-takers are small, the price-payers are large.**

## 2026-09-23 ~7:45am PDT — ⭐⭐⭐⭐ **THE FREIGHT WEDGE WIDENS US REFINERS' EDGE: ASIA PAYS ~$15-20/BBL TO MOVE GULF CRUDE WHILE US GULF COAST RUNS A SOFTENING LANDLOCKED BARREL.** *(Tanker chart + EIA; settled per rule 22.)*
- **THESIS: ME Gulf VLCC rates at ~2× record (~$870-970K/day) put a ~$15-20/bbl freight wedge on Gulf crude landed in Asia; US refiners run WTI/Americas crude that never touches Hormuz — and this week's Cushing +2.27MM build softens WTI further (the Brent-WTI spread moving in the refiners' favor). ⇒ Asian refining margins squeezed → fewer Asian product exports → the diesel shortage deepens, with US refiners as the LOW-COST supplier of the scarce product. Quadrant one + a cost-advantage layer. Irony noted: the same advantage an export ban would lock them out of — the cap stays relevant. VLO/MPC 9 HELD, case strengthened under the cap.**
- **⬜ UNWORKED NAMES (no grades): VLCC owners earning records — FRO / DHT / TNK / INSW-class; product tankers (STNG/TRMD/ASC, from the 9/22 ban scenario). Spikes like this mean-revert violently when the risk clears — workup before any grade.**
