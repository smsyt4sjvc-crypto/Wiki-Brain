...
> **31 dated entries · 2026-07-11 → 2026-08-24 · refreshed 2026-08-25 17:28 PDT**
>
...
**2026-07**
- `2026-07-11` `L97` Weekly structural pull (added 2026-07-11 — `tools/structural_pulls.py`)
- `2026-07-11` `L110` Monday flows routine (added 2026-07-11 — `tools/monday_flows.py`)
- `2026-07-11` `L118` Lag-vs-lead doctrine (2026-07-11, Jake's Q: "does this lag or indicate where money could go?")
- `2026-07-11` `L130` Form 4 reading hierarchy (2026-07-11 — the key for insider_pull output)
- `2026-07-12` `L145` Options asymmetry doctrine (2026-07-12, Jake's insight confirmed: "it's not equal opposites")
- `2026-07-12` `L155` Premium-selling doctrine (2026-07-12, Jake's Q: "how do I find the absurdly expensive ones to sell?")
- `2026-07-12` `L169` Sell-the-fear confluence (2026-07-12 — Jake's synthesis: rich IV puts x insider cluster buying)
- `2026-07-12` `L182` First confluence run (2026-07-12, Jake's Colab, 22 names) — ONE hit: GPK
- `2026-07-12` `L197` Short-dated selling addendum (2026-07-12, Jake's Q: 1-2 week puts?)
- `2026-07-12` `L207` GPK chain verdict (2026-07-12, spot $10.28)
- `2026-07-12` `L220` Market-wide confluence funnel (2026-07-12 — Jake: "scan the whole NASDAQ")
- `2026-07-12` `L231` 2026-07-12 — SEC: activists must disclose CLIENT identities in 13D/proxy filings (Reuters 7/10)
- `2026-07-13` `L244` 2026-07-13 ~9am PT — LangChain ships "OpenWiki Brains" = the vault's architecture, productized
- `2026-07-13` `L261` 2026-07-13 ~7:45pm PT — source calibration: the ZH-repost layer question (Jake's challenge)
- `2026-07-15` `L287` 2026-07-15 ~7:20am PT — rotation + unusual-options scanner (built)
- `2026-07-27` `L299` 2026-07-27 ~5:40am PT — NEW TOOL: the headline COLLECTOR (capture-everything → CSV → upload → Claude sorts)
**2026-08**
- `2026-08-09` `L309` 2026-08-09 ~12:55pm PDT — THE RESEARCH-ECOSYSTEM MAP (Jake's ranking) + the thesis-radar loop it commissioned
- `2026-08-10` `L324` 2026-08-10 ~6:50pm PDT — THE MAJORS' LAG, CODIFIED INTO A CONVENTION (Jake: "WSJ/Reuters… writing about things we've h
- `2026-08-11` `L356` 2026-08-11 ~11:10am PDT — 🔴 INFRASTRUCTURE: FRED IS DOWN FOR PROGRAMMATIC ACCESS, AND FOUR VAULT CELLS DEPEND ON IT
- `2026-08-11` `L399` 2026-08-11 ~4:20pm PDT — ★★★ JAKE'S API RULE, IMPLEMENTED AND MEASURED: "batch smaller requests" — the EDGAR win is 13
- `2026-08-12` `L440` 2026-08-12 ~2:35pm PDT — ⛔ A 429 IS NOT A TIMEOUT AND NOT AN AUTH WALL. THREE FAILURES, THREE TRIAGES.
- `2026-08-12` `L442` DATA (observed — this container, 2026-08-12)
- `2026-08-19` `L461` 2026-08-19 ~10:40am PDT — ⭐⭐⭐⭐ **QUOTE-HEADER RECONCILIATION — Jake is right that these headers never reconcile, and t
- `2026-08-22` `L522` 2026-08-22 — ⛔⛔⛔ **"FRED IS BLOCKED FROM THE CONTAINER" WAS WRONG FOR EIGHT MONTHS. FRED BOT-PROTECTS ON *USER-AGENT*,
- `2026-08-22` `L557` 2026-08-22 — ⛔ **I PREDICTED THE GITHUB RUNNER WOULD GET THROUGH YAHOO'S RATE LIMIT. IT DID NOT. THE RUN LOG SAYS 429,
- `2026-08-22` `L596` 2026-08-22 (same hour) — ⛔⛔ **I DECLARED MOVE "NO FREE SOURCE" AND BUILT A MANUAL PIPELINE AROUND IT WITHOUT TRYING WE
- `2026-08-22` `L636` ✅ 2026-08-22 (follow-up) — **JAKE'S GOOGLE SCREENSHOT VALIDATED THE VAULT'S ENTIRE STORED MOVE HISTORY, AND FOUND A BE
- `2026-08-22` `L663` ⛔ 2026-08-22 — **"TODAY" IS A LABEL, NOT A TIMESTAMP — AND MY OWN TOOL WOULD HAVE BELIEVED IT**
- `2026-08-22` `L684` 2026-08-22 — 🚩🚩🚩 **NEW STANDING CHECK: A CHINESE-LISTED COMPANY MUST ISSUE A 澄清公告 (CLARIFICATION ANNOUNCEMENT) WHEN A 
- `2026-08-24` `L707` 2026-08-24 ~2:00am PDT — 🔧 **THE GOPHER BRIEF, v1 — built AGAINST the three failures that actually happened on 8/23, n
- `2026-08-24` `L738` 2026-08-24 ~7:45pm PDT — ✅✅✅ **GOPHER BRIEF v1 GRADED AGAINST THE REGRESSION SUITE FIRST, AS REGISTERED — AND IT PASSE
