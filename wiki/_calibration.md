...
## 2026-09-26 ~8:23am PDT — ⏳ **THE KRE LESSON, CORRECTED AND SHARPENED: JAKE TOOK THE KRE PUTS IN FEBRUARY — SHORT-DATED — AND "THETA KILLED IT." A STATE THAT IS "FLASHING" IS NOT A DATE.**
  ⟲ EXTENDS trade-down-landing-pads.md:L76 (2026-09-26) — detail: short-dated puts, lost to theta; long-dated Dec puts also −70-85% (losses in CMBS, not banks) [old entry stays LIVE]
  ⟲ SUPERSEDES portfolio-state.md:L134 — Jake took the KRE puts in Feb (short-dated) and lost to theta — not 'passed on'
- **WHY THIS MATTERS (plain English):** an option is a bet on WHAT happens AND WHEN. The regional-bank stress was real and visible (a "warning"), but warnings don't say when; a short-dated put loses value every day the event doesn't arrive. Even the long-dated version (Dec-31 puts, the Feb workbook) lost ~70-85% because the losses landed on CMBS bondholders, not bank stocks. Two separate ways to be right and still lose money.
- **DATA:** Jake (8:23am): *"I took it but with a much shorter dated exp and lost my ass. That was the lesson lol. It ~was~ flashing but theta killed it."* · KRE $71.28 (2/13) → $62.62 (3/18, −12%) → $77.93 (8/14) → $71.55 (9/25) · the Feb workbook's Dec-31 $60 put $2.86 → $0.48 (`raw/2026-09-26-KRE_Short_Thesis_Sep2026.xlsx`).
- **THESIS (analysis) — two lessons, not one:** **(1) TIMING (theta):** a "flashing" state is the vault's WARNING, not a TRIGGER (rule 10) — short-dated options need a DATED catalyst; a state-based thesis belongs in a no-decay structure (stock short with a stop — how the ORCL short is built) or long-dated, small, pre-planned exits (the Feb workbook's $60-65 trigger fired 3/18 and was the one moment the trade paid). **(2) INSTRUMENT (who holds the loss):** CRE distress was RIGHT (office CMBS ~12%, multifamily still rising, sales ~20% below appraisal) but the losses sat with CMBS/private-credit holders, while banks had de-risked (Flagstar −$12B CRE) and got deregulation + M&A — "don't short the reliably-bailed-out asset class" (the older line above) is the same lesson from the other side. **⇒ Before any options short: name the DATE and name WHO HOLDS THE LOSS.**
- ⛔ **Record fix:** `portfolio-state` listed KRE puts as "passed on" — WRONG (superseded below); `trade-down-landing-pads` (took KRE shorts) was right.
**Links:** [[portfolio-state]] · [[trade-down-landing-pads]] · [[financing-fragility-gauge]] · [[money-board]]
