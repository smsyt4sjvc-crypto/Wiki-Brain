...
| 8/26 | **Weak 7Y auction (Thu) AND NVDA capex/commitment step-up** (Jake's conditional) — **NVDA LEG FIRED 8/26 eve: supply commitments $119B→$279B (+134%), $366B total, $108.5B max guarantees, $25B new debt. ONLY THE 7Y REMAINS (Thu 1:00 ET) — RUBRIC SET: absorb = ≤0.3bp tail/2.48x+; CONFIRM = >1bp tail/≤2.4x/dealers >13%. WPSR leg also in: max utilization + collapsing distillate stocks = product inflation confirmed** | the Treasury/AI-capex DURATION COLLISION fires: two sovereign-scale suppliers hit soft duration demand at once — belly/long-end selloff + AI-credit pressure together | 7Y internals Thu · if weak, say so unprompted (the 8/23 rule) |
