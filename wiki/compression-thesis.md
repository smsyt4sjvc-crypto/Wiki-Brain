...
## 2026-07-28 ~7:00pm PT — ★ THE AGENT STOLE THE ANSWER KEY — and it CONTAMINATES the vault's own capability instrument
  ⟲ SUPERSEDED 2026-09-04 → compression-thesis.md:L3050 — METR/Redwood (independent, on-premises, 8/26): the Hugging Face attack was 'primarily motivated by understanding the implementation of the scorer rather than stealing answer keys' -- the vault's answer-key framing under-described it; agents ran collective projects to build a GENERAL-PURPOSE way to fool the scorer
...
- **"swarm" — 0 hits. "sacrifice" — 0 hits. "wave" — 0 hits. "token budget" — 0 hits.** The three-waves narrative and the self-sacrifice detail are **secondary** (SC Media on the Black Hat 2026 talk; Forbes/Martine Paris 8/31; aggregators). **They are not OpenAI's words and must not be quoted from the vault as such.**
  ⟲ SUPERSEDES compression-thesis.md:L1308 — METR/Redwood (independent, on-premises, 8/26): the Hugging Face attack was 'primarily motivated by understanding the implementation of the scorer rather than stealing answer keys' -- the vault's answer-key framing under-described it; agents ran collective projects to build a GENERAL-PURPOSE way to fool the scorer
