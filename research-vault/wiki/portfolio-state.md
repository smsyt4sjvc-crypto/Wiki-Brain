...
> **36 dated entries · 2026-07-01 → 2026-08-16 · refreshed 2026-08-17 17:01 PDT**
>
...
**2026-07**
- `2026-07-01` `L153` ⚡ 2026-07-01 AM — hardware-is-the-risk (compute scarcity cracking)
- `2026-07-01` `L178` Jul-1 close — positions (2026-07-01 PM; `raw/2026-07-01-macro-scan.md`)
- `2026-07-07` `L231` ⚡ 2026-07-07 PM — Hormuz fuse #2 lighting; ORCL credit; thesis-crowding warning
- `2026-07-07` `L247` ⚡ 2026-07-07 PM — ladder cancelled; book restructured around rotation
- `2026-07-07` `L265` ⚡ 2026-07-07 — the ladder goes live (chips −6/−10%, rotation second-rank)
- `2026-07-08` `L200` ⚡ 2026-07-08 PM — CEASEFIRE DEAD; marker holding; diesel squeeze; gamma bid (`raw/2026-07-08-zh-feed-ceasefire-over.md
- `2026-07-08` `L215` ⚡ 2026-07-08 — from Jake's Jul-6/7 trading-session log (`raw/2026-07-07-wiki-log-jul6-7.md`)
- `2026-07-09` `L58` ⚠️ DATA — CORRECTED ACTUAL BOOK (Jake's direct disclosure, 2026-07-09)
- `2026-07-09` `L289` ⚡ 2026-07-09 — the "just buy the semi basket" impulse (logged, not executed)
- `2026-07-09` `L303` ⚡ 2026-07-09 — the median line vs the book (the tool disagrees with the posture)
- `2026-07-13` `L319` 2026-07-13 ~12:20pm PT — FILL CONFIRMED: SPY Jul-15 $750 straddle (the event position)
- `2026-07-15` `L335` 2026-07-15 ~7:55am PT — SPY Jul-15 750 straddle: OUTCOME (Jake's marks)
- `2026-07-15` `L349` 2026-07-15 ~9:30am PT — MU CLOSED: stopped out at $850 (~−13%, ~$520 on 4 shares)
- `2026-07-15` `L388` 2026-07-15 ~12:01pm PT — MU $901 (−8.31% day); Jake's chart read (lower highs / H&S)
- `2026-07-15` `L416` 2026-07-15 ~12:05pm PT — addendum: 4h Bollinger = first change-of-character of the whole cycle
- `2026-07-16` `L438` 2026-07-16 ~8:20am PT — MU re-entry read: TSMC capex hike (bull tell) vs Korea/SOX derisk (headwind)
- `2026-07-16` `L457` 2026-07-16 eve — MU memory-unwind via Korea (NOT a re-entry); TSMC beat sold
- `2026-07-17` `L71` 2026-07-17 ~5:04pm PT — SIZING clarified (Jake): ~$12k book; the "$1k" is a ring-fenced AI carve-out
- `2026-07-17` `L80` 2026-07-17 ~5:12pm PT — ACTUAL BOOK (Jake screenshot) — the real current holdings, $12,025 total
- `2026-07-17` `L89` 2026-07-17 — ⚠️ CLOSED-TRADE POST-MORTEM: MNST Jul 87.5 puts −$446 (~87% loss)
- `2026-07-17` `L466` ACCOUNT CONSTRAINTS (durable — "remember my limits", logged 2026-07-17 ~11am PT)
- `2026-07-23` `L481` 2026-07-23 ~9:10am PT — bought 2 SPY @ $738.46 (dip nibble, VIX-18.7 DECIDE zone)
- `2026-07-30` `L493` 2026-07-30 3:01pm PT — SPY Dec-745 PUT: the full P&L decomposition (Fidelity screen, 5:58pm ET)
- `2026-07-30` `L542` 2026-07-30 3:09pm PT — ⛔ SUPERSEDES THE ENTRY ABOVE: Jake supplied spot (742). It was DELTA, not vol.
- `2026-07-30` `L578` 2026-07-30 3:20pm PT — ✅ CLOSED: Jake "pretty sure it was ATM when I bought." System fully determined.
- `2026-07-30` `L621` 2026-07-30 3:34pm PT — 📈 THE STOCK SCREEN IS A PRICE FEED. Real spots ⇒ the day was 73/27, not 98/2.
- `2026-07-31` `L665` 2026-07-31 12:40pm PDT — ★★★ THE FULL BOOK, 45 POSITIONS. Structure ≠ intent.
- `2026-07-31` `L722` 2026-07-31 ~1:10pm PDT — ⛔ JAKE'S RATIONALE ANSWERS MOST OF MY CRITIQUE. What survives is one tension he named himself
- `2026-07-31` `L777` 2026-07-31 ~1:25pm PDT — THE INDEX COMPLEX MARKED: SPY basis 736.96, QQQM basis 283.58
- `2026-07-31` `L815` 2026-07-31 ~4:55pm PDT — 90-DAY PLAN, PRE-WORK: capital map, the theta hurdle, and the screen
**2026-08**
- `2026-08-01` `L856` 2026-08-01 ~1:05pm PDT — ★★★ THE LOSS NUMBER LANDS: 35%, AND IT DELETES THE PLAN'S SHAPE
- `2026-08-07` `L897` 2026-08-07 ~10:35am PDT — 🚩 THE NUCLEAR BASKET'S MISSING EXIT CONDITION IS NOW REGISTERED (closes the L725 open flag)
- `2026-08-11` `L906` 2026-08-11 ~9:30am PDT — 📌 TWO BASKETS ENTER THE BOOK RECORD: full holdings, current vs target weights, and an instrum
- `2026-08-11` `L958` 2026-08-11 ~9:35am PDT — ★★★★ THE BASKETS RUN: SAME RETURN, MORE RISK — the extra 15 non-semi names in Basket 2 did NO
- `2026-08-16` `L1016` 2026-08-16 ~7:38pm PDT — ⚠️⚠️ JAKE FLIPS: BEARISH → **CAUTIOUSLY OPTIMISTIC BULLISH**, citing the 8/13 "doesn't matter
- `2026-08-16` `L1076` 2026-08-16 ~9:02pm PDT — ★★★★★ JAKE FORMALISES THE BULL STANCE AS A REGIME-FOLLOWING RULE, AND IT IS CONSISTENT WITH T
